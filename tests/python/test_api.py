...
class TestTiglLogging(unittest.TestCase):
    def get_logs(self, loglevel):
        process=subprocess.Popen(['python', 'logging_helper.py', "%s" % loglevel], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    def test_info(self):
        ...
        self.assertTrue(out[0].strip().endswith('Done meshing'))
        self.assertTrue(out[1].startswith('INF'))
        self.assertTrue(out[1].strip().endswith(' vertices.'))
        ...
        self.assertTrue(err[1].strip().endswith('No object is registered for uid "nonexistent"'))
    ...
    def test_error(self):
        ...
        self.assertTrue(err[0].strip().endswith('No object is registered for uid "nonexistent"'))
    ...
    def test_file_logging(self):
        ...
        self.assertTrue(lout[2].strip().endswith("Done meshing"))
        self.assertTrue(lout[3].startswith('INF'))
        self.assertTrue(lout[3].strip().endswith(' vertices.'))
        self.assertTrue(lout[4].startswith('ERR'))
        self.assertTrue(lout[4].strip().endswith('No object is registered for uid "nonexistent"'))
...
class TestTiglApi(unittest.TestCase):
    def setUp(self):
        ...
        self.tixi.open('TestData/CPACS_30_D150.xml')
