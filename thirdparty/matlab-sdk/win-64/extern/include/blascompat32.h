/*
 * @(#)blascompat32.h    generated by: makeheader 5.1.5  Thu Jan 15 19:16:26 2009
 *
...
EXTERN_C float cdotc32(const int *n32, const creal32_T *cx, const int *incx32,
              const creal32_T *cy, const int *incy32);



#define zdotc32 FORTRAN_WRAPPER(zdotc32)
EXTERN_C double zdotc32(const int *n32, const creal_T *zx, const int *incx32,
...
EXTERN_C float cdotu32(const int *n32, const creal32_T *cx, const int *incx32, 
              const creal32_T *cy, const int *incy32);



#define zdotu32 FORTRAN_WRAPPER(zdotu32)
EXTERN_C double zdotu32(const int *n32, const creal_T *zx, const int *incx32, 
               const creal_T *zy, const int *incy32);
