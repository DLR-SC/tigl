...
IF( NOT OpenCASCADE_FOUND )
  ...
  ELSE(UNIX)
    IF (WIN32)
      ...
      set( _libsearchpath $ENV{CASROOT}\\win32\\lib $ENV{CASROOT}\\win${BITS}\\vc9\\lib $ENV{CASROOT}\\win${BITS}\\vc10\\lib C:\\OpenCASCADE6.3.0\\ros\\win32\\lib )
	  set( _dllsearchpath $ENV{CASROOT}\\win32\\bin $ENV{CASROOT}\\win${BITS}\\vc9\\bin $ENV{CASROOT}\\win${BITS}\\vc10\\bin C:\\OpenCASCADE6.3.0\\ros\\win32\\bin )
	  message(STATUS "Bitnessss: ${_libsearchpath}")
    ELSE(WIN32)
