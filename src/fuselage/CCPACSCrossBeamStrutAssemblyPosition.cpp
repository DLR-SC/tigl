...
CCPACSCrossBeamStrutAssemblyPosition::CCPACSCrossBeamStrutAssemblyPosition(CCPACSCargoCrossBeamStrutsAssembly* parent,
    ...
    , m_geometry{{*this, &CCPACSCrossBeamStrutAssemblyPosition ::BuildGeometry3D}, {*this, &CCPACSCrossBeamStrutAssemblyPosition ::BuildGeometry1D}}
{
}
...
{
    TopoDS_Shape shape = *m_geometry[just1DElements];
