...
public:
  ...
  TIGL_EXPORT void ReadCPACS(const TixiDocumentHandle &tixiHandle,
...
TIGL_EXPORT const CCPACSWingComponentSegment &
ComponentSegment(const CCPACSLeadingEdgeDevice &);
TIGL_EXPORT CCPACSWingComponentSegment &
ComponentSegment(CCPACSLeadingEdgeDevice &);
