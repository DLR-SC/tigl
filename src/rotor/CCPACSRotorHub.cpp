...
TiglRotorHubType CCPACSRotorHub::GetType() const
{
    ...
    switch (*m_type) {
        case generated::CPACSRotorHub_type::articulated: return TiglRotorHubType::TIGLROTORHUB_ARTICULATED;
        case generated::CPACSRotorHub_type::hingeless:   return TiglRotorHubType::TIGLROTORHUB_HINGELESS;
        case generated::CPACSRotorHub_type::rigid:       return TiglRotorHubType::TIGLROTORHUB_RIGID;
        case generated::CPACSRotorHub_type::semiRigid:   return TiglRotorHubType::TIGLROTORHUB_SEMI_RIGID;
