...
namespace tigl{
        ...
        CTiglNACA4Calculator::CTiglNACA4Calculator(double max_camber_cl, double max_camber_position, double reflex, double max_profile_thickness, double trailing_edge_thickness)
         : series_(Series::NACA5)
                              ...
                              te_thickness)
        {
            if (naca_code.size() == 4){
                ...
                try{
                    ...
                    *this = CTiglNACA4Calculator(s, p, q, tt, te_thickness);
                }
                catch(...){
                throw CTiglError("error in CTiglNACA4Calculator: the naca_code format is not correct, it must to contain four digits and nothing else");
            }
        ...
        double CTiglNACA4Calculator::k1_const(double max_camber, double max_camber_position, double reflex) const{
            ...
            switch(meanline_designation){
                ...
                case 250:
                    ...
                    break;
                case 211:
                    throw ::std::logic_error("error in CTiglNACA4Calculator::k1: this profile does not provide a constant for k1."); //gibts hier nh ander elösung, mit dem ich rechnen kann?
                    break;
                case 221:
                    k1 = 51.99;
                    break;
        ...
        double CTiglNACA4Calculator::m_const(double max_camber, double max_camber_position, double reflex) const{
            int max_camber_cl_whole = static_cast<int>(max_camber*100);
            int max_camber_position_whole = static_cast<int>(max_camber_position*20);
            int reflex_int = static_cast<int>(reflex);
            double m;
            ...
            switch(meanline_designation){
                ...
                case 250:
                    ...
                    break;
                case 211:
                    throw ::std::logic_error("error in CTiglNACA4Calculator::m: this profile does not provide a constant for m."); //gibts hier nh ander elösung, mit dem ich rechnen kann?
                    break;
                case 221:
                    m = 0.1300;
                    break;
        ...
        double CTiglNACA4Calculator::k2k1_const(double max_camber, double max_camber_position, double reflex) const{
            int max_camber_cl_whole = static_cast<int>(max_camber*100);
            int max_camber_position_whole = static_cast<int>(max_camber_position*20);
            int reflex_int = static_cast<int>(reflex);
            double k2k1;
            ...
            switch(meanline_designation){
                case 210:
                     throw ::std::logic_error("error in CTiglNACA4Calculator::k2k1: this profile does not provide a constant for k2/k1.");
                     break;
                case 220:
                     throw ::std::logic_error("error in CTiglNACA4Calculator::k2k1: this profile does not provide a constant for k2/k1.");
                     break;
                case 230:
                     throw ::std::logic_error("error in CTiglNACA4Calculator::k2k1: this profile does not provide a constant for k2/k1m.");
                     break;
                case 240:
                    throw ::std::logic_error("error in CTiglNACA4Calculator::k2k1: this profile does not provide a constant for k2/k1.");
                    break;
                case 250:
                    ...
                    break;
                case 211:
                    throw ::std::logic_error("error in CTiglNACA4Calculator::k2k1: this profile does not provide a constant for k2/k1."); //gibts hier nh ander elösung, mit dem ich rechnen kann?
                    break;
                case 221:
                    k2k1 = 0.000764;
                    break;
                ...
                case 251:
                    ...
                    break;
                default:
                    throw ::std::logic_error("error in CTiglNACA4Calculator::k2k1: this profile does not provide a constant for m."); //gibts hier nh ander elösung, mit dem ich rechnen kann?
                    break;
                }
            return k2k1; 
        }
        ...
        double CTiglNACA4Calculator::camberline(double x) const{
            ...
            if(series_ == Series::NACA4){
                ...
                if(x < 0 || x > 1){
                    throw CTiglError("error in CTiglNACA4Calculator::camberline::NACA4: x must be between 0 and 1.");
                }
                else if(x <= p){
                ...
                if(q == 0){
                    ...
                    throw ::std::logic_error("error in CTiglNACA4Calculator::camberline::NACA5: x must be between 0 and 1.");
                }
                return 0;
            }
            return 0;
        ...
        double CTiglNACA4Calculator::camberline_derivative(double x) const{ //c'(x)
            ...
            if(series_ == Series::NACA4){
                ...
                if(q == 0){
                    ...
                    else if(x > p){ //hier statt p au 0.3180 oder war das was anderes?
                        return -((k1*m*m*m)/6);
                    }
                }
                else if(q==1){
