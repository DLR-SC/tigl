...
namespace generated
{
    CPACSAlignmentStringFrame::CPACSAlignmentStringFrame(CCPACSFuselageStringerFramePosition* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSFuselageStringerFramePosition* CPACSAlignmentStringFrame::GetParent() const
    {
        return m_parent;
    }

    CCPACSFuselageStringerFramePosition* CPACSAlignmentStringFrame::GetParent()
    {
        return m_parent;
    }

    const CTiglUIDObject* CPACSAlignmentStringFrame::GetNextUIDParent() const
    {
        return m_parent;
    }

    CTiglUIDObject* CPACSAlignmentStringFrame::GetNextUIDParent()
    {
        return m_parent;
    }
