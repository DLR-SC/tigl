...
namespace tigl
{
    namespace generated
    {
        CPACSMIntegratedModularAvionics::CPACSMIntegratedModularAvionics(){}
        CPACSMIntegratedModularAvionics::~CPACSMIntegratedModularAvionics() {}
        
        void CPACSMIntegratedModularAvionics::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMIntegratedModularAvionics::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMIntegratedModularAvionics::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMIntegratedModularAvionics::GetMassDescription()
        {
            return m_massDescription;
        }
