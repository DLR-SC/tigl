...
namespace generated
{
    ...
    void CPACSWallPosition::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
    {
        ...
        if (m_bulkheadUID_choice1) {
            tixi::TixiCreateElementIfNotExists(tixiHandle, xpath + "/bulkheadUID");
        ...
        if (m_wallSegmentUID_choice2) {
            tixi::TixiCreateElementIfNotExists(tixiHandle, xpath + "/wallSegmentUID");
        ...
        if (m_fuselageSectionUID_choice3) {
            tixi::TixiCreateElementIfNotExists(tixiHandle, xpath + "/fuselageSectionUID");
