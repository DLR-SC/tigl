...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT CPACSEtaIsoLine(CCPACSWingRibExplicitPositioning* parent);
        TIGL_EXPORT CPACSEtaIsoLine(CCPACSWingRibsPositioning* parent);
