...
namespace generated
{
    ...
    private:
        ...
        CPACSSystemConnections& operator=(const CPACSSystemConnections&) = delete;

        CPACSSystemConnections(CPACSSystemConnections&&) = delete;
        CPACSSystemConnections& operator=(CPACSSystemConnections&&) = delete;
    };
} // namespace generated
