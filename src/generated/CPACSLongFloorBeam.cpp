...
namespace generated
{
    ...
    const CTiglUIDObject* CPACSLongFloorBeam::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSLongFloorBeam::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSLongFloorBeam::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/longFloorBeamPosition")) {
            tixi::TixiReadElements(tixiHandle, xpath + "/longFloorBeamPosition", m_longFloorBeamPositions, 2, tixi::xsdUnbounded, reinterpret_cast<CCPACSLongFloorBeam*>(this), m_uidMgr);
        }
    ...
    size_t CPACSLongFloorBeam::GetLongFloorBeamPositionIndex(const std::string& UID) const
    {
        ...
        throw CTiglError("Invalid UID in CPACSLongFloorBeam::GetLongFloorBeamPositionIndex", TIGL_UID_ERROR);
    }
