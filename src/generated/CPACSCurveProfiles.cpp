...
namespace generated
{
    ...
    const CTiglUIDObject* CPACSCurveProfiles::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSCurveProfiles::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSCurveProfiles::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/curveProfile")) {
            tixi::TixiReadElements(tixiHandle, xpath + "/curveProfile", m_curveProfiles, 1, tixi::xsdUnbounded, this, m_uidMgr);
        }
    ...
    size_t CPACSCurveProfiles::GetCurveProfileIndex(const std::string& UID) const
    {
        ...
        throw CTiglError("Invalid UID in CPACSCurveProfiles::GetCurveProfileIndex", TIGL_UID_ERROR);
    }
