...
namespace tigl
{
    namespace generated
    {
        ...
        // CPACSControlSurfaceHingeMomentMaps
        
        // generated from /xsd:schema/xsd:complexType[177]
        class CPACSControlSurfaceHingeMomentMap
        {
        public:
            TIGL_EXPORT CPACSControlSurfaceHingeMomentMap();
            TIGL_EXPORT virtual ~CPACSControlSurfaceHingeMomentMap();
        ...
        private:
            #ifdef HAVE_CPP11
            CPACSControlSurfaceHingeMomentMap(const CPACSControlSurfaceHingeMomentMap&) = delete;
            CPACSControlSurfaceHingeMomentMap& operator=(const CPACSControlSurfaceHingeMomentMap&) = delete;
            
            CPACSControlSurfaceHingeMomentMap(CPACSControlSurfaceHingeMomentMap&&) = delete;
            CPACSControlSurfaceHingeMomentMap& operator=(CPACSControlSurfaceHingeMomentMap&&) = delete;
            #else
            CPACSControlSurfaceHingeMomentMap(const CPACSControlSurfaceHingeMomentMap&);
            CPACSControlSurfaceHingeMomentMap& operator=(const CPACSControlSurfaceHingeMomentMap&);
            #endif
        };
    }
    ...
    #ifdef CPP11
    using CCPACSControlSurfaceHingeMomentMap = generated::CPACSControlSurfaceHingeMomentMap;
    #else
    typedef generated::CPACSControlSurfaceHingeMomentMap CCPACSControlSurfaceHingeMomentMap;
    #endif
}
