...
namespace tigl
{
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSCutLoad();
            TIGL_EXPORT virtual ~CPACSCutLoad();
        ...
        private:
            #ifdef HAVE_CPP11
            CPACSCutLoad(const CPACSCutLoad&) = delete;
            CPACSCutLoad& operator=(const CPACSCutLoad&) = delete;
            
            CPACSCutLoad(CPACSCutLoad&&) = delete;
            CPACSCutLoad& operator=(CPACSCutLoad&&) = delete;
            #else
            CPACSCutLoad(const CPACSCutLoad&);
            CPACSCutLoad& operator=(const CPACSCutLoad&);
            #endif
        };
    }
    ...
    #ifdef CPP11
    using CCPACSCutLoad = generated::CPACSCutLoad;
    #else
    typedef generated::CPACSCutLoad CCPACSCutLoad;
    #endif
}
