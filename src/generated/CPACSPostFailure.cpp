...
namespace generated
{
    CPACSPostFailure::CPACSPostFailure(CPACSMaterial* parent)
    {
        //assert(parent != NULL);
        m_parent = parent;
    }
    ...
    const CPACSMaterial* CPACSPostFailure::GetParent() const
    {
        return m_parent;
    }

    CPACSMaterial* CPACSPostFailure::GetParent()
    {
        return m_parent;
    }

    const CTiglUIDObject* CPACSPostFailure::GetNextUIDParent() const
    {
        return m_parent;
    }

    CTiglUIDObject* CPACSPostFailure::GetNextUIDParent()
    {
        return m_parent;
    }
    ...
    void CPACSPostFailure::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/plasticityCurvePoint")) {
            tixi::TixiReadElements(tixiHandle, xpath + "/plasticityCurvePoint", m_plasticityCurvePoints_choice1, 0, tixi::xsdUnbounded, this);
        }
    ...
    {
        const std::vector<std::string> childElemOrder = { "name", "description", "materialLaw", "plasticEliminationStrain", "plasticityCurvePoint", "initialEquivalentShearStrain", "intermediateEquivalentShearStrain", "ultimateEquivalentShearStrain", "intermediateDamage", "ultimateDamage" };
        ...
        if (m_materialLaw) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/materialLaw", childElemOrder);
        ...
        if (m_plasticEliminationStrain_choice1) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/plasticEliminationStrain", childElemOrder);
        ...
        if (m_initialEquivalentShearStrain_choice2) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/initialEquivalentShearStrain", childElemOrder);
        ...
        if (m_intermediateEquivalentShearStrain_choice2) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/intermediateEquivalentShearStrain", childElemOrder);
        ...
        if (m_ultimateEquivalentShearStrain_choice2) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/ultimateEquivalentShearStrain", childElemOrder);
        ...
        if (m_intermediateDamage_choice2) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/intermediateDamage", childElemOrder);
        ...
        if (m_ultimateDamage_choice2) {
            tixi::TixiCreateSequenceElementIfNotExists(tixiHandle, xpath + "/ultimateDamage", childElemOrder);
    ...
    {
        m_plasticityCurvePoints_choice1.push_back(make_unique<CPACSPlasticityCurvePoint>(this));
