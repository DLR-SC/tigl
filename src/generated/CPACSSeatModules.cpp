...
namespace generated
{
    CPACSSeatModules::CPACSSeatModules(CCPACSDecksDeck* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSDecksDeck* CPACSSeatModules::GetParent() const
    {
        return m_parent;
    }

    CCPACSDecksDeck* CPACSSeatModules::GetParent()
    {
        return m_parent;
    }
