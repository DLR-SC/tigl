...
namespace tigl
{
    namespace generated
    {
        CPACSMFireProtection::CPACSMFireProtection(){}
        CPACSMFireProtection::~CPACSMFireProtection() {}
        
        void CPACSMFireProtection::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMFireProtection::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMFireProtection::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMFireProtection::GetMassDescription()
        {
            return m_massDescription;
        }
