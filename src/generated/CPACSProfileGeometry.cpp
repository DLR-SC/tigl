...
namespace generated
{
    CPACSProfileGeometry::CPACSProfileGeometry(CCPACSFuselageProfiles* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
        m_parentType = &typeid(CCPACSFuselageProfiles);
    }

    CPACSProfileGeometry::CPACSProfileGeometry(CCPACSRotorProfiles* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
        m_parentType = &typeid(CCPACSRotorProfiles);
    }

    CPACSProfileGeometry::CPACSProfileGeometry(CCPACSWingProfiles* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
        m_parentType = &typeid(CCPACSWingProfiles);
    }
    ...
    void CPACSProfileGeometry::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/pointList")) {
            m_pointList_choice1 = boost::in_place(this);
            try {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/cst2D")) {
            m_cst2D_choice2 = boost::in_place(this);
            try {
