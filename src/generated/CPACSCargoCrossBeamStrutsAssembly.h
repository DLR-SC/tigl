...
namespace tigl
{
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSCargoCrossBeamStrutsAssembly();
            TIGL_EXPORT virtual ~CPACSCargoCrossBeamStrutsAssembly();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSCrossBeamStrutAssemblyPosition>>& GetCargoCrossBeamStrut() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSCrossBeamStrutAssemblyPosition>>& GetCargoCrossBeamStrut();
            
        protected:
            std::vector<unique_ptr<CPACSCrossBeamStrutAssemblyPosition>> m_cargoCrossBeamStrut;
    ...
    #ifdef CPP11
    using CCPACSCargoCrossBeamStrutsAssembly = generated::CPACSCargoCrossBeamStrutsAssembly;
    #else
    typedef generated::CPACSCargoCrossBeamStrutsAssembly CCPACSCargoCrossBeamStrutsAssembly;
    #endif
