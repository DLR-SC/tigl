...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSSysElemGenericComponents(CCPACSSystemElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSSysElemGenericComponents();
    ...
    private:
        CPACSSysElemGenericComponents(const CPACSSysElemGenericComponents&) = delete;
        CPACSSysElemGenericComponents& operator=(const CPACSSysElemGenericComponents&) = delete;

        CPACSSysElemGenericComponents(CPACSSysElemGenericComponents&&) = delete;
        CPACSSysElemGenericComponents& operator=(CPACSSysElemGenericComponents&&) = delete;
    };
} // namespace generated
