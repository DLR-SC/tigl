...
namespace tigl
{
    namespace generated
    {
        CPACSMFuel::CPACSMFuel(){}
        CPACSMFuel::~CPACSMFuel() {}
        
        void CPACSMFuel::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMFuel::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMFuel::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMFuel::GetMassDescription()
        {
            return m_massDescription;
        }
        
        const std::vector<unique_ptr<CPACSFuelInTank>>& CPACSMFuel::GetFuelInTank() const
        {
            return m_fuelInTank;
        }
        
        std::vector<unique_ptr<CPACSFuelInTank>>& CPACSMFuel::GetFuelInTank()
        {
            return m_fuelInTank;
        }
