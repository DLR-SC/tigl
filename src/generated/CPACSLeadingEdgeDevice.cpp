...
namespace generated
{
    CPACSLeadingEdgeDevice::CPACSLeadingEdgeDevice(CPACSLeadingEdgeDevices* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_outerShape(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr)
        , m_path(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    }
    ...
    const CPACSLeadingEdgeDevices* CPACSLeadingEdgeDevice::GetParent() const
    {
        return m_parent;
    }

    CPACSLeadingEdgeDevices* CPACSLeadingEdgeDevice::GetParent()
    {
        return m_parent;
    }

    const CTiglUIDObject* CPACSLeadingEdgeDevice::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSLeadingEdgeDevice::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    CTiglUIDManager& CPACSLeadingEdgeDevice::GetUIDManager()
    {
        if (!m_uidMgr) {
    ...
    const CTiglUIDManager& CPACSLeadingEdgeDevice::GetUIDManager() const
    {
        if (!m_uidMgr) {
            throw CTiglError("UIDManager is null");
        }
    ...
    void CPACSLeadingEdgeDevice::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/wingCutOut")) {
            m_wingCutOut = boost::in_place(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr);
            try {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/structure")) {
            m_structure = boost::in_place(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr);
            try {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/tracks")) {
            m_tracks = boost::in_place(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr);
            try {
    ...
    const boost::optional<std::string>& CPACSLeadingEdgeDevice::GetDescription() const
    {
        return m_description;
    }

    void CPACSLeadingEdgeDevice::SetDescription(const boost::optional<std::string>& value)
    {
        m_description = value;
    }
    ...
    const CCPACSControlSurfaceOuterShapeLeadingEdge& CPACSLeadingEdgeDevice::GetOuterShape() const
    {
        return m_outerShape;
    }

    CCPACSControlSurfaceOuterShapeLeadingEdge& CPACSLeadingEdgeDevice::GetOuterShape()
    {
        return m_outerShape;
    }

    const boost::optional<CCPACSControlSurfaceWingCutOut>& CPACSLeadingEdgeDevice::GetWingCutOut() const
    {
        return m_wingCutOut;
    }

    boost::optional<CCPACSControlSurfaceWingCutOut>& CPACSLeadingEdgeDevice::GetWingCutOut()
    {
        return m_wingCutOut;
    }

    const boost::optional<CCPACSWingCSStructure>& CPACSLeadingEdgeDevice::GetStructure() const
    {
        return m_structure;
    }

    boost::optional<CCPACSWingCSStructure>& CPACSLeadingEdgeDevice::GetStructure()
    {
        return m_structure;
    }
    ...
    const boost::optional<CPACSControlSurfaceTracks>& CPACSLeadingEdgeDevice::GetTracks() const
    {
        return m_tracks;
    }

    boost::optional<CPACSControlSurfaceTracks>& CPACSLeadingEdgeDevice::GetTracks()
    {
        return m_tracks;
    }

    CCPACSControlSurfaceWingCutOut& CPACSLeadingEdgeDevice::GetWingCutOut(CreateIfNotExistsTag)
    {
        if (!m_wingCutOut)
            m_wingCutOut = boost::in_place(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr);
        return *m_wingCutOut;
    ...
    void CPACSLeadingEdgeDevice::RemoveWingCutOut()
    {
        m_wingCutOut = boost::none;
    }

    CCPACSWingCSStructure& CPACSLeadingEdgeDevice::GetStructure(CreateIfNotExistsTag)
    {
        if (!m_structure)
            m_structure = boost::in_place(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr);
        return *m_structure;
    ...
    void CPACSLeadingEdgeDevice::RemoveStructure()
    {
        m_structure = boost::none;
    }

    CPACSControlSurfaceTracks& CPACSLeadingEdgeDevice::GetTracks(CreateIfNotExistsTag)
    {
        if (!m_tracks)
            m_tracks = boost::in_place(reinterpret_cast<CCPACSLeadingEdgeDevice*>(this), m_uidMgr);
        return *m_tracks;
    ...
    void CPACSLeadingEdgeDevice::RemoveTracks()
    {
        m_tracks = boost::none;
    }

    const CTiglUIDObject* CPACSLeadingEdgeDevice::GetNextUIDObject() const
    {
        return this;
    }

    void CPACSLeadingEdgeDevice::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
