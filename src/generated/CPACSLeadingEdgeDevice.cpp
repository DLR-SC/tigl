...
namespace generated
{
    CPACSLeadingEdgeDevice::CPACSLeadingEdgeDevice(CCPACSLeadingEdgeDevices* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    ...
    const CCPACSLeadingEdgeDevices* CPACSLeadingEdgeDevice::GetParent() const
    {
        return m_parent;
    }

    CCPACSLeadingEdgeDevices* CPACSLeadingEdgeDevice::GetParent()
    {
        return m_parent;
    }
