...
namespace tigl
{
    namespace generated
    {
        CPACSCenterFuselagePressureFloor::CPACSCenterFuselagePressureFloor(){}
        CPACSCenterFuselagePressureFloor::~CPACSCenterFuselagePressureFloor() {}
        
        void CPACSCenterFuselagePressureFloor::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            // read attribute uID
            ...
            // read element startHorizontalFrameUID
            if (tixihelper::TixiCheckElement(tixiHandle, xpath + "/startHorizontalFrameUID")) {
                m_startHorizontalFrameUID = tixihelper::TixiGetElement<std::string>(tixiHandle, xpath + "/startHorizontalFrameUID");
            }
            else {
                LOG(ERROR) << "Required element startHorizontalFrameUID is missing";
            }
        ...
        void CPACSCenterFuselagePressureFloor::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            // write attribute uID
            if (m_uID) {
            ...
            // write element startHorizontalFrameUID
            tixihelper::TixiCreateElementIfNotExists(tixiHandle, xpath + "/startHorizontalFrameUID");
            tixihelper::TixiSaveElement(tixiHandle, xpath + "/startHorizontalFrameUID", m_startHorizontalFrameUID);
        ...
        bool CPACSCenterFuselagePressureFloor::HasUID() const
        {
            return static_cast<bool>(m_uID);
        }
        
        const std::string& CPACSCenterFuselagePressureFloor::GetUID() const
        {
            return *m_uID;
        }
        
        void CPACSCenterFuselagePressureFloor::SetUID(const std::string& value)
        {
            m_uID = value;
        }
        
        const std::string& CPACSCenterFuselagePressureFloor::GetPositionZStringerUID() const
        {
            return m_positionZStringerUID;
        }
        
        void CPACSCenterFuselagePressureFloor::SetPositionZStringerUID(const std::string& value)
        {
            m_positionZStringerUID = value;
        }
        
        const std::string& CPACSCenterFuselagePressureFloor::GetStartHorizontalFrameUID() const
        {
            return m_startHorizontalFrameUID;
        }
        
        void CPACSCenterFuselagePressureFloor::SetStartHorizontalFrameUID(const std::string& value)
        {
            m_startHorizontalFrameUID = value;
        }
        
        const double& CPACSCenterFuselagePressureFloor::GetMembraneRadius() const
        {
            return m_membraneRadius;
        }
        
        void CPACSCenterFuselagePressureFloor::SetMembraneRadius(const double& value)
        {
            m_membraneRadius = value;
        }
        
        const std::string& CPACSCenterFuselagePressureFloor::GetSheetElementUID() const
        {
            return m_sheetElementUID;
        }
        
        void CPACSCenterFuselagePressureFloor::SetSheetElementUID(const std::string& value)
        {
            m_sheetElementUID = value;
        }
        
        const std::string& CPACSCenterFuselagePressureFloor::GetReinforcementElementUID() const
        {
            return m_reinforcementElementUID;
        }
        
        void CPACSCenterFuselagePressureFloor::SetReinforcementElementUID(const std::string& value)
        {
