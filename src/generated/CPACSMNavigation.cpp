...
namespace tigl
{
    namespace generated
    {
        CPACSMNavigation::CPACSMNavigation(){}
        CPACSMNavigation::~CPACSMNavigation() {}
        
        void CPACSMNavigation::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMNavigation::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMNavigation::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMNavigation::GetMassDescription()
        {
            return m_massDescription;
        }
