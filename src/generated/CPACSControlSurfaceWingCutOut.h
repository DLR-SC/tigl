...
public:
  TIGL_EXPORT CPACSControlSurfaceWingCutOut(CCPACSLeadingEdgeDevice *parent,
                                            CTiglUIDManager *uidMgr);
  // TIGL_EXPORT CPACSControlSurfaceWingCutOut(CCPACSSpoiler* parent,
  // CTiglUIDManager* uidMgr);
  ...
  template <typename P> bool IsParent() const {
    return m_parentType != NULL && *m_parentType == typeid(P);
  }

  template <typename P> P *GetParent() {
    static_assert(std::is_same<P, CCPACSLeadingEdgeDevice>::value ||
                      std::is_same<P, CCPACSTrailingEdgeDevice>::value,
                  "template argument for P is not a parent class of "
  ...
  template <typename P> const P *GetParent() const {
    static_assert(std::is_same<P, CCPACSLeadingEdgeDevice>::value ||
                      std::is_same<P, CCPACSTrailingEdgeDevice>::value,
                  "template argument for P is not a parent class of "
                  "CPACSControlSurfaceWingCutOut");
  ...
  TIGL_EXPORT virtual const boost::optional<CPACSCutOutControlPoints> &
  GetCutOutProfileControlPoint() const;
  TIGL_EXPORT virtual boost::optional<CPACSCutOutControlPoints> &
  GetCutOutProfileControlPoint();

  TIGL_EXPORT virtual const boost::optional<CPACSCutOutProfiles> &
  GetCutOutProfiles() const;
  TIGL_EXPORT virtual boost::optional<CPACSCutOutProfiles> &GetCutOutProfiles();

  TIGL_EXPORT virtual const boost::optional<
      CPACSControlSurfaceSkinCutOutBorder> &
  GetInnerBorder() const;
  TIGL_EXPORT virtual boost::optional<CPACSControlSurfaceSkinCutOutBorder> &
  GetInnerBorder();

  TIGL_EXPORT virtual const boost::optional<
      CPACSControlSurfaceSkinCutOutBorder> &
  GetOuterBorder() const;
  TIGL_EXPORT virtual boost::optional<CPACSControlSurfaceSkinCutOutBorder> &
  GetOuterBorder();

  TIGL_EXPORT virtual CPACSCutOutControlPoints &
      GetCutOutProfileControlPoint(CreateIfNotExistsTag);
  TIGL_EXPORT virtual void RemoveCutOutProfileControlPoint();

  TIGL_EXPORT virtual CPACSCutOutProfiles &
      GetCutOutProfiles(CreateIfNotExistsTag);
  TIGL_EXPORT virtual void RemoveCutOutProfiles();

  TIGL_EXPORT virtual CPACSControlSurfaceSkinCutOutBorder &
      GetInnerBorder(CreateIfNotExistsTag);
  TIGL_EXPORT virtual void RemoveInnerBorder();

  TIGL_EXPORT virtual CPACSControlSurfaceSkinCutOutBorder &
      GetOuterBorder(CreateIfNotExistsTag);
...
private:
  ...
  CPACSControlSurfaceWingCutOut &
  operator=(const CPACSControlSurfaceWingCutOut &) = delete;

  CPACSControlSurfaceWingCutOut(CPACSControlSurfaceWingCutOut &&) = delete;
  CPACSControlSurfaceWingCutOut &
  operator=(CPACSControlSurfaceWingCutOut &&) = delete;
};
} // namespace generated

// CPACSControlSurfaceWingCutOut is customized, use type
// CCPACSControlSurfaceWingCutOut directly
} // namespace tigl
