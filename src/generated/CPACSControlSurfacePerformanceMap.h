...
namespace tigl
{
    namespace generated
    {
        ...
        // CPACSControlSurfacePerformanceMaps
        
        // generated from /xsd:schema/xsd:complexType[184]
        class CPACSControlSurfacePerformanceMap
        {
        public:
            TIGL_EXPORT CPACSControlSurfacePerformanceMap();
            TIGL_EXPORT virtual ~CPACSControlSurfacePerformanceMap();
        ...
        private:
            #ifdef HAVE_CPP11
            CPACSControlSurfacePerformanceMap(const CPACSControlSurfacePerformanceMap&) = delete;
            CPACSControlSurfacePerformanceMap& operator=(const CPACSControlSurfacePerformanceMap&) = delete;
            
            CPACSControlSurfacePerformanceMap(CPACSControlSurfacePerformanceMap&&) = delete;
            CPACSControlSurfacePerformanceMap& operator=(CPACSControlSurfacePerformanceMap&&) = delete;
            #else
            CPACSControlSurfacePerformanceMap(const CPACSControlSurfacePerformanceMap&);
            CPACSControlSurfacePerformanceMap& operator=(const CPACSControlSurfacePerformanceMap&);
            #endif
        };
    }
    ...
    #ifdef CPP11
    using CCPACSControlSurfacePerformanceMap = generated::CPACSControlSurfacePerformanceMap;
    #else
    typedef generated::CPACSControlSurfacePerformanceMap CCPACSControlSurfacePerformanceMap;
    #endif
}
