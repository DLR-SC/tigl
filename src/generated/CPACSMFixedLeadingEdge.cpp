...
namespace tigl
{
    namespace generated
    {
        CPACSMFixedLeadingEdge::CPACSMFixedLeadingEdge(){}
        CPACSMFixedLeadingEdge::~CPACSMFixedLeadingEdge() {}
        
        void CPACSMFixedLeadingEdge::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMFixedLeadingEdge::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMFixedLeadingEdge::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMFixedLeadingEdge::GetMassDescription()
        {
            return m_massDescription;
        }
