...
namespace tigl
{
    namespace generated
    {
        ...
        // generated from /xsd:schema/xsd:complexType[303]
        class CPACSEnginePosition
        {
        public:
            TIGL_EXPORT CPACSEnginePosition();
            ...
            TIGL_EXPORT const std::string& GetEngineUID() const;
            TIGL_EXPORT void SetEngineUID(const std::string& value);
    ...
    #ifdef CPP11
    using CCPACSEnginePosition = generated::CPACSEnginePosition;
    #else
    typedef generated::CPACSEnginePosition CCPACSEnginePosition;
    #endif
}
