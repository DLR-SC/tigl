...
namespace generated
{
    ...
    /// 
    class CPACSMainActuator : public CTiglReqUIDObject, public ITiglUIDRefObject
    {
    public:
        TIGL_EXPORT CPACSMainActuator(CPACSLandingGearComponentAssembly* parent, CTiglUIDManager* uidMgr);
