...
namespace tigl
{
    namespace generated
    {
        CPACSMAirConditioning::CPACSMAirConditioning(){}
        CPACSMAirConditioning::~CPACSMAirConditioning() {}
        
        void CPACSMAirConditioning::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMAirConditioning::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMAirConditioning::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMAirConditioning::GetMassDescription()
        {
            return m_massDescription;
        }
