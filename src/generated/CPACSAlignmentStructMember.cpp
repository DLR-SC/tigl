...
namespace generated
{
    CPACSAlignmentStructMember::CPACSAlignmentStructMember(CCPACSLongFloorBeamPosition* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSLongFloorBeamPosition* CPACSAlignmentStructMember::GetParent() const
    {
        return m_parent;
    }

    CCPACSLongFloorBeamPosition* CPACSAlignmentStructMember::GetParent()
    {
        return m_parent;
    }

    const CTiglUIDObject* CPACSAlignmentStructMember::GetNextUIDParent() const
    {
        return m_parent;
    }

    CTiglUIDObject* CPACSAlignmentStructMember::GetNextUIDParent()
    {
        return m_parent;
    }
