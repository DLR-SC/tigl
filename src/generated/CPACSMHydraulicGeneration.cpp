...
namespace tigl
{
    namespace generated
    {
        CPACSMHydraulicGeneration::CPACSMHydraulicGeneration(){}
        CPACSMHydraulicGeneration::~CPACSMHydraulicGeneration() {}
        
        void CPACSMHydraulicGeneration::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMHydraulicGeneration::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMHydraulicGeneration::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMHydraulicGeneration::GetMassDescription()
        {
            return m_massDescription;
        }
