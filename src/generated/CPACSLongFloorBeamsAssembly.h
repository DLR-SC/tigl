...
namespace tigl
{
    namespace generated
    {
        ...
        // generated from /xsd:schema/xsd:complexType[507]
        class CPACSLongFloorBeamsAssembly
        {
        public:
            TIGL_EXPORT CPACSLongFloorBeamsAssembly();
            TIGL_EXPORT virtual ~CPACSLongFloorBeamsAssembly();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSLongFloorBeam>>& GetLongFloorBeam() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSLongFloorBeam>>& GetLongFloorBeam();
            
        protected:
            std::vector<unique_ptr<CPACSLongFloorBeam>> m_longFloorBeam;
    ...
    #ifdef CPP11
    using CCPACSLongFloorBeamsAssembly = generated::CPACSLongFloorBeamsAssembly;
    #else
    typedef generated::CPACSLongFloorBeamsAssembly CCPACSLongFloorBeamsAssembly;
    #endif
    
    using generated::CPACSLongFloorBeam;
}
