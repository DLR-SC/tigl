...
namespace tigl
{
    namespace generated
    {
        CPACSMAutomaticFlightSystem::CPACSMAutomaticFlightSystem(){}
        CPACSMAutomaticFlightSystem::~CPACSMAutomaticFlightSystem() {}
        
        void CPACSMAutomaticFlightSystem::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMAutomaticFlightSystem::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMAutomaticFlightSystem::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMAutomaticFlightSystem::GetMassDescription()
        {
            return m_massDescription;
        }
