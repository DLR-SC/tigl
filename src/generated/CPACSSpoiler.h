...
namespace generated
{
    ...
    /// 
    class CPACSSpoiler : public CTiglReqUIDObject, public ITiglUIDRefObject
    {
    public:
        TIGL_EXPORT CPACSSpoiler(CCPACSSpoilers* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSSpoiler();

        TIGL_EXPORT CCPACSSpoilers* GetParent();

        TIGL_EXPORT const CCPACSSpoilers* GetParent() const;
        ...
        TIGL_EXPORT virtual const CPACSControlSurfaceOuterShapeSpoiler& GetOuterShape() const;
        TIGL_EXPORT virtual CPACSControlSurfaceOuterShapeSpoiler& GetOuterShape();
...
// CPACSSpoiler is customized, use type CCPACSSpoiler directly
} // namespace tigl
