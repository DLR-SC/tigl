...
namespace tigl
{
    namespace generated
    {
        CPACSMFuelSystem::CPACSMFuelSystem(){}
        CPACSMFuelSystem::~CPACSMFuelSystem() {}
        
        void CPACSMFuelSystem::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMFuelSystem::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMFuelSystem::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMFuelSystem::GetMassDescription()
        {
            return m_massDescription;
        }
