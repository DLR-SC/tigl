...
namespace tigl
{
    namespace generated
    {
        ...
        void CPACSRotorcraftModel::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            ...
            // read element driveSystems
            if (tixihelper::TixiCheckElement(tixiHandle, xpath + "/driveSystems")) {
                m_driveSystems = boost::in_place();
                try {
                    m_driveSystems->ReadCPACS(tixiHandle, xpath + "/driveSystems");
                } catch(const std::exception& e) {
                    LOG(ERROR) << "Failed to read driveSystems at xpath << " << xpath << ": " << e.what();
                    m_driveSystems = boost::none;
                } catch(const CTiglError& e) {
                    LOG(ERROR) << "Failed to read driveSystems at xpath << " << xpath << ": " << e.getError();
                    m_driveSystems = boost::none;
                }
            }
        ...
        void CPACSRotorcraftModel::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            ...
            // write element driveSystems
            if (m_driveSystems) {
                tixihelper::TixiCreateElementIfNotExists(tixiHandle, xpath + "/driveSystems");
                m_driveSystems->WriteCPACS(tixiHandle, xpath + "/driveSystems");
            }
        ...
        bool CPACSRotorcraftModel::HasEngines() const
        {
            return static_cast<bool>(m_engines);
        }
        
        const CPACSEnginePositions& CPACSRotorcraftModel::GetEngines() const
        {
            return *m_engines;
        }
        
        CPACSEnginePositions& CPACSRotorcraftModel::GetEngines()
        {
            return *m_engines;
        }
        
        bool CPACSRotorcraftModel::HasDriveSystems() const
        {
            return static_cast<bool>(m_driveSystems);
        }
        
        const CPACSDriveSystems& CPACSRotorcraftModel::GetDriveSystems() const
        {
            return *m_driveSystems;
        }
        
        CPACSDriveSystems& CPACSRotorcraftModel::GetDriveSystems()
        {
            return *m_driveSystems;
        }
        
        bool CPACSRotorcraftModel::HasLandingGear() const
        {
            return static_cast<bool>(m_landingGear);
        }
        
        const CPACSLandingGear& CPACSRotorcraftModel::GetLandingGear() const
        {
            return *m_landingGear;
        }
        
        CPACSLandingGear& CPACSRotorcraftModel::GetLandingGear()
        {
            return *m_landingGear;
        }
        
        bool CPACSRotorcraftModel::HasSystems() const
        {
            return static_cast<bool>(m_systems);
        }
        
        const CPACSSystems& CPACSRotorcraftModel::GetSystems() const
        {
            return *m_systems;
        }
        
        CPACSSystems& CPACSRotorcraftModel::GetSystems()
        {
            return *m_systems;
        }
        
        bool CPACSRotorcraftModel::HasGlobal() const
        {
            return static_cast<bool>(m_global);
        }
        
        const CPACSRotorcraftGlobal& CPACSRotorcraftModel::GetGlobal() const
        {
            return *m_global;
        }
        
        CPACSRotorcraftGlobal& CPACSRotorcraftModel::GetGlobal()
        {
            return *m_global;
        }
        
        bool CPACSRotorcraftModel::HasAnalyses() const
        {
            return static_cast<bool>(m_analyses);
        }
        
        const CPACSRotorcraftAnalyses& CPACSRotorcraftModel::GetAnalyses() const
        {
            return *m_analyses;
        }
        
        CPACSRotorcraftAnalyses& CPACSRotorcraftModel::GetAnalyses()
        {
            return *m_analyses;
        }
