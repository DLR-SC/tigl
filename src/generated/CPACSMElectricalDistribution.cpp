...
namespace tigl
{
    namespace generated
    {
        CPACSMElectricalDistribution::CPACSMElectricalDistribution(){}
        CPACSMElectricalDistribution::~CPACSMElectricalDistribution() {}
        
        void CPACSMElectricalDistribution::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMElectricalDistribution::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMElectricalDistribution::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMElectricalDistribution::GetMassDescription()
        {
            return m_massDescription;
        }
