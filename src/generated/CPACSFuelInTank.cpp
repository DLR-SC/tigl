...
namespace tigl
{
    namespace generated
    {
        CPACSFuelInTank::CPACSFuelInTank(){}
        CPACSFuelInTank::~CPACSFuelInTank() {}
        
        void CPACSFuelInTank::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSFuelInTank::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSFuelInTank::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSFuelInTank::GetMassDescription()
        {
            return m_massDescription;
        }
