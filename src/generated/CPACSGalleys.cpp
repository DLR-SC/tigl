...
namespace generated
{
    CPACSGalleys::CPACSGalleys(CCPACSDecksDeck* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSDecksDeck* CPACSGalleys::GetParent() const
    {
        return m_parent;
    }

    CCPACSDecksDeck* CPACSGalleys::GetParent()
    {
        return m_parent;
    }
