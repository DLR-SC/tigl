...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT CPACSLeadingEdgeDevices* GetParent();

        TIGL_EXPORT const CPACSLeadingEdgeDevices* GetParent() const;
        ...
        TIGL_EXPORT virtual const CCPACSControlSurfaceOuterShapeLeadingEdge& GetOuterShape() const;
        TIGL_EXPORT virtual CCPACSControlSurfaceOuterShapeLeadingEdge& GetOuterShape();
