...
namespace tigl
{
    namespace generated
    {
        CPACSActuatorFuselageWingAttachment::CPACSActuatorFuselageWingAttachment(){}
        CPACSActuatorFuselageWingAttachment::~CPACSActuatorFuselageWingAttachment() {}
        
        void CPACSActuatorFuselageWingAttachment::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            // read element eta
        ...
        void CPACSActuatorFuselageWingAttachment::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            // write element eta
        ...
        const double& CPACSActuatorFuselageWingAttachment::GetEta() const
        {
            return m_eta;
        }
        
        void CPACSActuatorFuselageWingAttachment::SetEta(const double& value)
        {
            m_eta = value;
        }
        
        const double& CPACSActuatorFuselageWingAttachment::GetXsi() const
        {
            return m_xsi;
        }
        
        void CPACSActuatorFuselageWingAttachment::SetXsi(const double& value)
        {
            m_xsi = value;
        }
        
        const double& CPACSActuatorFuselageWingAttachment::GetRelHeight() const
        {
            return m_relHeight;
        }
        
        void CPACSActuatorFuselageWingAttachment::SetRelHeight(const double& value)
        {
            m_relHeight = value;
        }
        
        const CCPACSMaterial& CPACSActuatorFuselageWingAttachment::GetMaterial() const
        {
            return m_material;
        }
        
        CCPACSMaterial& CPACSActuatorFuselageWingAttachment::GetMaterial()
        {
            return m_material;
        }
