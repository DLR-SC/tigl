...
namespace generated
{
    CPACSControlSurfaceBorderLeadingEdge::CPACSControlSurfaceBorderLeadingEdge(CPACSControlSurfaceOuterShapeLeadingEdge* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    ...
    const CPACSControlSurfaceOuterShapeLeadingEdge* CPACSControlSurfaceBorderLeadingEdge::GetParent() const
    {
        return m_parent;
    }

    CPACSControlSurfaceOuterShapeLeadingEdge* CPACSControlSurfaceBorderLeadingEdge::GetParent()
    {
        return m_parent;
    }
    ...
    void CPACSControlSurfaceBorderLeadingEdge::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/xsiTE")) {
            m_xsiTE_choice1 = boost::in_place(this, m_uidMgr);
            try {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/innerShape")) {
            m_innerShape_choice1 = boost::in_place(this);
            try {
