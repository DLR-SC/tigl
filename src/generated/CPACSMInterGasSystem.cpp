...
namespace tigl
{
    namespace generated
    {
        CPACSMInterGasSystem::CPACSMInterGasSystem(){}
        CPACSMInterGasSystem::~CPACSMInterGasSystem() {}
        
        void CPACSMInterGasSystem::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMInterGasSystem::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMInterGasSystem::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMInterGasSystem::GetMassDescription()
        {
            return m_massDescription;
        }
