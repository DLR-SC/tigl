...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual ~CPACSSysElemSuperCapacitors();
        ...
        TIGL_EXPORT virtual const std::vector<std::unique_ptr<CPACSVehicleElementBase>>& GetSuperCapacitors() const;
        TIGL_EXPORT virtual std::vector<std::unique_ptr<CPACSVehicleElementBase>>& GetSuperCapacitors();

        TIGL_EXPORT virtual size_t GetSuperCapacitorCount() const;
        TIGL_EXPORT virtual size_t GetSuperCapacitorIndex(const std::string& UID) const;

        TIGL_EXPORT virtual const CPACSVehicleElementBase& GetSuperCapacitor(size_t index) const;
        TIGL_EXPORT virtual CPACSVehicleElementBase& GetSuperCapacitor(size_t index);

        TIGL_EXPORT virtual const CPACSVehicleElementBase& GetSuperCapacitor(const std::string& UID) const;
        TIGL_EXPORT virtual CPACSVehicleElementBase& GetSuperCapacitor(const std::string& UID);

        TIGL_EXPORT virtual CPACSVehicleElementBase& AddSuperCapacitor();
        TIGL_EXPORT virtual void RemoveSuperCapacitor(CPACSVehicleElementBase& ref);
    ...
    private:
        ...
        CPACSSysElemSuperCapacitors& operator=(const CPACSSysElemSuperCapacitors&) = delete;

        CPACSSysElemSuperCapacitors(CPACSSysElemSuperCapacitors&&) = delete;
        CPACSSysElemSuperCapacitors& operator=(CPACSSysElemSuperCapacitors&&) = delete;
    };
} // namespace generated
