...
namespace generated
{
    ...
    private:
        CPACSAircraftControlElements(const CPACSAircraftControlElements&) = delete;
        CPACSAircraftControlElements& operator=(const CPACSAircraftControlElements&) = delete;

        CPACSAircraftControlElements(CPACSAircraftControlElements&&) = delete;
        CPACSAircraftControlElements& operator=(CPACSAircraftControlElements&&) = delete;
    };
} // namespace generated
