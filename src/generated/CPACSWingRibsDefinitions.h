...
namespace tigl
{
    ...
    namespace generated
    {
        ...
        public:
            ...
            TIGL_EXPORT const std::vector<unique_ptr<CCPACSWingRibsDefinition> >& GetRibsDefinition() const;
            TIGL_EXPORT std::vector<unique_ptr<CCPACSWingRibsDefinition> >& GetRibsDefinition();
            
        protected:
            CCPACSWingCSStructure* m_parent;
            
            std::vector<unique_ptr<CCPACSWingRibsDefinition> > m_ribsDefinition;
    ...
    // This type is customized, use type CCPACSWingRibsDefinitions
}
