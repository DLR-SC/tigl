...
#include "CPACSAeroPerformanceMapRC.h"

namespace tigl
{
    namespace generated
    {
        CPACSAeroPerformanceMapRC::CPACSAeroPerformanceMapRC(){}
        CPACSAeroPerformanceMapRC::~CPACSAeroPerformanceMapRC() {}
        
        void CPACSAeroPerformanceMapRC::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            ...
            // read element analysisTool
            if (tixihelper::TixiCheckElement(tixiHandle, xpath + "/analysisTool")) {
                m_analysisTool = boost::in_place();
                try {
                    m_analysisTool->ReadCPACS(tixiHandle, xpath + "/analysisTool");
                } catch(const std::exception& e) {
                    LOG(ERROR) << "Failed to read analysisTool at xpath << " << xpath << ": " << e.what();
                    m_analysisTool = boost::none;
                } catch(const CTiglError& e) {
                    LOG(ERROR) << "Failed to read analysisTool at xpath << " << xpath << ": " << e.getError();
                    m_analysisTool = boost::none;
                }
            }
            
            // read element analysisLevel
            if (tixihelper::TixiCheckElement(tixiHandle, xpath + "/analysisLevel")) {
                m_analysisLevel = tixihelper::TixiGetElement<int>(tixiHandle, xpath + "/analysisLevel");
            }
        ...
        void CPACSAeroPerformanceMapRC::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            ...
            // write element analysisTool
            if (m_analysisTool) {
                tixihelper::TixiCreateElementIfNotExists(tixiHandle, xpath + "/analysisTool");
                m_analysisTool->WriteCPACS(tixiHandle, xpath + "/analysisTool");
            }
            
            // write element analysisLevel
            if (m_analysisLevel) {
                tixihelper::TixiCreateElementIfNotExists(tixiHandle, xpath + "/analysisLevel");
                tixihelper::TixiSaveElement(tixiHandle, xpath + "/analysisLevel", *m_analysisLevel);
            }
        ...
        const CCPACSStringVector& CPACSAeroPerformanceMapRC::GetMachNumber() const
        {
            return m_machNumber;
        }
        
        CCPACSStringVector& CPACSAeroPerformanceMapRC::GetMachNumber()
        {
            return m_machNumber;
        }
        
        const CCPACSStringVector& CPACSAeroPerformanceMapRC::GetReynoldsNumber() const
        {
            return m_reynoldsNumber;
        }
        
        CCPACSStringVector& CPACSAeroPerformanceMapRC::GetReynoldsNumber()
        {
            return m_reynoldsNumber;
        }
        
        const CCPACSStringVector& CPACSAeroPerformanceMapRC::GetAngleOfYaw() const
        {
            return m_angleOfYaw;
        }
        
        CCPACSStringVector& CPACSAeroPerformanceMapRC::GetAngleOfYaw()
        {
            return m_angleOfYaw;
        }
        
        const CCPACSStringVector& CPACSAeroPerformanceMapRC::GetAngleOfAttack() const
        {
            return m_angleOfAttack;
        }
        
        CCPACSStringVector& CPACSAeroPerformanceMapRC::GetAngleOfAttack()
        {
            return m_angleOfAttack;
        }
        
        bool CPACSAeroPerformanceMapRC::HasAnalysisTool() const
        {
            return static_cast<bool>(m_analysisTool);
        }
        
        const CPACSTool& CPACSAeroPerformanceMapRC::GetAnalysisTool() const
        {
            return *m_analysisTool;
        }
        
        CPACSTool& CPACSAeroPerformanceMapRC::GetAnalysisTool()
        {
            return *m_analysisTool;
        }
        
        bool CPACSAeroPerformanceMapRC::HasAnalysisLevel() const
        {
            return static_cast<bool>(m_analysisLevel);
        }
        
        const int& CPACSAeroPerformanceMapRC::GetAnalysisLevel() const
        {
            return *m_analysisLevel;
        }
        
        void CPACSAeroPerformanceMapRC::SetAnalysisLevel(const int& value)
        {
            m_analysisLevel = value;
        }
        
        bool CPACSAeroPerformanceMapRC::HasCfx() const
        {
            return static_cast<bool>(m_cfx);
        }
        
        const CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCfx() const
        {
            return *m_cfx;
        }
        
        CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCfx()
        {
            return *m_cfx;
        }
        
        bool CPACSAeroPerformanceMapRC::HasCfy() const
        {
            return static_cast<bool>(m_cfy);
        }
        
        const CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCfy() const
        {
            return *m_cfy;
        }
        
        CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCfy()
        {
            return *m_cfy;
        }
        
        bool CPACSAeroPerformanceMapRC::HasCfz() const
        {
            return static_cast<bool>(m_cfz);
        }
        
        const CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCfz() const
        {
            return *m_cfz;
        }
        
        CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCfz()
        {
            return *m_cfz;
        }
        
        bool CPACSAeroPerformanceMapRC::HasCmx() const
        {
            return static_cast<bool>(m_cmx);
        }
        
        const CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCmx() const
        {
            return *m_cmx;
        }
        
        CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCmx()
        {
            return *m_cmx;
        }
        
        bool CPACSAeroPerformanceMapRC::HasCmy() const
        {
            return static_cast<bool>(m_cmy);
        }
        
        const CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCmy() const
        {
            return *m_cmy;
        }
        
        CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCmy()
        {
            return *m_cmy;
        }
        
        bool CPACSAeroPerformanceMapRC::HasCmz() const
        {
            return static_cast<bool>(m_cmz);
        }
        
        const CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCmz() const
        {
            return *m_cmz;
        }
        
        CPACSStringArrayBase& CPACSAeroPerformanceMapRC::GetCmz()
        {
            return *m_cmz;
        }
        
        bool CPACSAeroPerformanceMapRC::HasDampingDerivatives() const
        {
            return static_cast<bool>(m_dampingDerivatives);
        }
        
        const CPACSDampingDerivativesRates& CPACSAeroPerformanceMapRC::GetDampingDerivatives() const
        {
            return *m_dampingDerivatives;
        }
        
        CPACSDampingDerivativesRates& CPACSAeroPerformanceMapRC::GetDampingDerivatives()
        {
            return *m_dampingDerivatives;
        }
