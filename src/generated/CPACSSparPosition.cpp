...
namespace generated
{
    CPACSSparPosition::CPACSSparPosition(CCPACSWingSparPositions* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_sparPoint(reinterpret_cast<CCPACSWingSparPosition*>(this))
    {
        //assert(parent != NULL);
        m_parent = parent;
    }
    ...
    const CCPACSEtaXsiRelHeightPoint& CPACSSparPosition::GetSparPoint() const
    {
        return m_sparPoint;
    }

    CCPACSEtaXsiRelHeightPoint& CPACSSparPosition::GetSparPoint()
    {
        return m_sparPoint;
    }
