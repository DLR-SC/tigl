...
namespace tigl
{
    namespace generated
    {
        ...
        const std::vector<unique_ptr<CCPACSFuselageSectionElement>>& CPACSFuselageElements::GetElement() const
        {
            return m_element;
        }
        
        std::vector<unique_ptr<CCPACSFuselageSectionElement>>& CPACSFuselageElements::GetElement()
        {
            return m_element;
        }
