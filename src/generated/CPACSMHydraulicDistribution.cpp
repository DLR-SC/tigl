...
namespace tigl
{
    namespace generated
    {
        CPACSMHydraulicDistribution::CPACSMHydraulicDistribution(){}
        CPACSMHydraulicDistribution::~CPACSMHydraulicDistribution() {}
        
        void CPACSMHydraulicDistribution::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMHydraulicDistribution::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMHydraulicDistribution::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMHydraulicDistribution::GetMassDescription()
        {
            return m_massDescription;
        }
