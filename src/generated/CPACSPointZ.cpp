...
namespace generated
{
    CPACSPointZ::CPACSPointZ(CPACSTransformation2D* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_z(0)
    {
        //assert(parent != NULL);
    ...
    const boost::optional<std::string>& CPACSPointZ::GetUID() const
    {
        return m_uID;
    }

    void CPACSPointZ::SetUID(const boost::optional<std::string>& value)
    {
