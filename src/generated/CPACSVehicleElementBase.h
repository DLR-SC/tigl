...
namespace generated
{
    ...
    // CPACSSysElemHydraulicPowerPackages
    ...
    public:
        ...
        TIGL_EXPORT CPACSVehicleElementBase(CPACSSysElemHydraulicPowerPackages* parent, CTiglUIDManager* uidMgr);
