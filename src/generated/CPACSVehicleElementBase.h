...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSVehicleElementBase(CPACSGenericComponents* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSVehicleElementBase();

        TIGL_EXPORT CPACSGenericComponents* GetParent();

        TIGL_EXPORT const CPACSGenericComponents* GetParent() const;
    ...
    protected:
        CPACSGenericComponents* m_parent;
