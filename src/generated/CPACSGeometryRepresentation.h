...
namespace generated
{
    ...
    inline CPACSGeometryRepresentation stringToCPACSGeometryRepresentation(const std::string& value)
    {
...
using ECPACSGeometryRepresentation = generated::CPACSGeometryRepresentation;
} // namespace tigl
