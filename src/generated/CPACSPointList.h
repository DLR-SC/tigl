...
namespace tigl
{
    ...
    namespace generated
    {
        ...
        // generated from /xsd:schema/xsd:complexType[683]
        class CPACSPointList
        {
        public:
            TIGL_EXPORT CPACSPointList();
            TIGL_EXPORT virtual ~CPACSPointList();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CCPACSPoint>>& GetPoint() const;
            TIGL_EXPORT std::vector<unique_ptr<CCPACSPoint>>& GetPoint();
            
        protected:
            std::vector<unique_ptr<CCPACSPoint>> m_point;
