...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const CCPACSPoint& GetPoint(size_t index) const;
        TIGL_EXPORT virtual CCPACSPoint& GetPoint(size_t index);

        TIGL_EXPORT virtual const CCPACSPoint& GetPoint(const std::string& UID) const;
        TIGL_EXPORT virtual CCPACSPoint& GetPoint(const std::string& UID);
