...
namespace generated
{
    CPACSEtaXsiRelHeightPoint::CPACSEtaXsiRelHeightPoint(CCPACSWingSparPosition* parent)
        : m_eta(0)
        , m_xsi(0)
    {
        //assert(parent != NULL);
    ...
    const CCPACSWingSparPosition* CPACSEtaXsiRelHeightPoint::GetParent() const
    {
        return m_parent;
    }

    CCPACSWingSparPosition* CPACSEtaXsiRelHeightPoint::GetParent()
    {
        return m_parent;
    }
