...
namespace tigl
{
    namespace generated
    {
        CPACSAttachmentPinPosition::CPACSAttachmentPinPosition(){}
        CPACSAttachmentPinPosition::~CPACSAttachmentPinPosition() {}
        
        void CPACSAttachmentPinPosition::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            // read element eta
        ...
        void CPACSAttachmentPinPosition::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            // write element eta
        ...
        const double& CPACSAttachmentPinPosition::GetEta() const
        {
            return m_eta;
        }
        
        void CPACSAttachmentPinPosition::SetEta(const double& value)
        {
            m_eta = value;
        }
        
        const double& CPACSAttachmentPinPosition::GetXsi() const
        {
            return m_xsi;
        }
        
        void CPACSAttachmentPinPosition::SetXsi(const double& value)
        {
            m_xsi = value;
        }
        
        const double& CPACSAttachmentPinPosition::GetRelHeight() const
        {
            return m_relHeight;
        }
        
        void CPACSAttachmentPinPosition::SetRelHeight(const double& value)
        {
            m_relHeight = value;
        }
