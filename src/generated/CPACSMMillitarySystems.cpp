...
namespace tigl
{
    namespace generated
    {
        CPACSMMillitarySystems::CPACSMMillitarySystems(){}
        CPACSMMillitarySystems::~CPACSMMillitarySystems() {}
        
        void CPACSMMillitarySystems::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMMillitarySystems::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMMillitarySystems::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMMillitarySystems::GetMassDescription()
        {
            return m_massDescription;
        }
