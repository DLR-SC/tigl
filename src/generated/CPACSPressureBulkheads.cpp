...
namespace generated
{
    ...
    size_t CPACSPressureBulkheads::GetPressureBulkheadIndex(const std::string& UID) const
    {
        ...
        throw CTiglError("Invalid UID in CPACSPressureBulkheads::GetPressureBulkheadIndex", TIGL_UID_ERROR);
    }
    ...
    {
        m_pressureBulkheads.push_back(std::make_unique<CCPACSPressureBulkhead>(this, m_uidMgr));
