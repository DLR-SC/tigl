...
namespace tigl
{
    namespace generated
    {
        CPACSSingleGenericMass::CPACSSingleGenericMass(){}
        CPACSSingleGenericMass::~CPACSSingleGenericMass() {}
        
        void CPACSSingleGenericMass::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSSingleGenericMass::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSSingleGenericMass::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSSingleGenericMass::GetMassDescription()
        {
            return m_massDescription;
        }
