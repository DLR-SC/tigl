...
namespace tigl
{
    namespace generated
    {
        CPACSMElectricalGeneration::CPACSMElectricalGeneration(){}
        CPACSMElectricalGeneration::~CPACSMElectricalGeneration() {}
        
        void CPACSMElectricalGeneration::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMElectricalGeneration::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMElectricalGeneration::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMElectricalGeneration::GetMassDescription()
        {
            return m_massDescription;
        }
