...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const CPACSControlSurfaceStep& GetStep(const std::string& UID) const;
        TIGL_EXPORT virtual CPACSControlSurfaceStep& GetStep(const std::string& UID);
