...
namespace tigl
{
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSControlSurfaceSteps();
            TIGL_EXPORT virtual ~CPACSControlSurfaceSteps();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSControlSurfaceStep>>& GetStep() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSControlSurfaceStep>>& GetStep();
            
        protected:
            std::vector<unique_ptr<CPACSControlSurfaceStep>> m_step;
    ...
    #else
    typedef generated::CPACSControlSurfaceSteps CCPACSControlSurfaceSteps;
    #endif
    
    using generated::CPACSControlSurfaceStep;
}
