...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSSheetBasedStructuralElement(CPACSSheetBasedStructuralElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSSheetBasedStructuralElement();

        TIGL_EXPORT CPACSSheetBasedStructuralElements* GetParent();

        TIGL_EXPORT const CPACSSheetBasedStructuralElements* GetParent() const;
    ...
    protected:
        CPACSSheetBasedStructuralElements* m_parent;
