...
namespace generated
{
    ...
    CPACSGuideCurve::~CPACSGuideCurve()
    {
        ...
        if (m_uidMgr) {
            if (m_fromGuideCurveUID_choice1 && !m_fromGuideCurveUID_choice1->empty()) m_uidMgr->TryUnregisterReference(*m_fromGuideCurveUID_choice1, *this);
        }
    }

    const CCPACSGuideCurves* CPACSGuideCurve::GetParent() const
    {
        return m_parent;
    }

    CCPACSGuideCurves* CPACSGuideCurve::GetParent()
    {
        return m_parent;
    }

    const CTiglUIDObject* CPACSGuideCurve::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSGuideCurve::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSGuideCurve::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/fromGuideCurveUID")) {
            ...
            if (m_uidMgr && !m_fromGuideCurveUID_choice1->empty()) m_uidMgr->RegisterReference(*m_fromGuideCurveUID_choice1, *this);
        }
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/tangent")) {
            m_tangent_choice2 = boost::in_place(reinterpret_cast<CCPACSGuideCurve*>(this), m_uidMgr);
            try {
        ...
        // read element tangent
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/tangent")) {
            m_tangent = boost::in_place(reinterpret_cast<CCPACSGuideCurve*>(this), m_uidMgr);
            try {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/rXDirection")) {
            m_rXDirection = boost::in_place(reinterpret_cast<CCPACSGuideCurve*>(this), m_uidMgr);
            try {
    ...
    const CTiglUIDObject* CPACSGuideCurve::GetNextUIDObject() const
    {
        return this;
    }

    void CPACSGuideCurve::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
        if (m_fromGuideCurveUID_choice1 && *m_fromGuideCurveUID_choice1 == oldUid) {
            m_fromGuideCurveUID_choice1 = newUid;
        }
    }
