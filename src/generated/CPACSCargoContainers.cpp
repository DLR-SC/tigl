...
namespace generated
{
    CPACSCargoContainers::CPACSCargoContainers(CCPACSDecksDeck* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSDecksDeck* CPACSCargoContainers::GetParent() const
    {
        return m_parent;
    }

    CCPACSDecksDeck* CPACSCargoContainers::GetParent()
    {
        return m_parent;
    }
