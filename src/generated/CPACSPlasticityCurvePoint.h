...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSPlasticityCurvePoint(CPACSPostFailure* parent);

        TIGL_EXPORT virtual ~CPACSPlasticityCurvePoint();

        TIGL_EXPORT CPACSPostFailure* GetParent();

        TIGL_EXPORT const CPACSPostFailure* GetParent() const;
