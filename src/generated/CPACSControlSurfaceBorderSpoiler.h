...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSControlSurfaceBorderSpoiler(CPACSControlSurfaceOuterShapeSpoiler* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSControlSurfaceBorderSpoiler();

        TIGL_EXPORT CPACSControlSurfaceOuterShapeSpoiler* GetParent();

        TIGL_EXPORT const CPACSControlSurfaceOuterShapeSpoiler* GetParent() const;
        ...
        TIGL_EXPORT virtual const CCPACSXsiIsoLine& GetXsiTE() const;
        TIGL_EXPORT virtual CCPACSXsiIsoLine& GetXsiTE();

        TIGL_EXPORT virtual const boost::optional<double>& GetRelHeightLE_choice1() const;
        TIGL_EXPORT virtual void SetRelHeightLE_choice1(const boost::optional<double>& value);
    ...
    protected:
        CPACSControlSurfaceOuterShapeSpoiler* m_parent;
