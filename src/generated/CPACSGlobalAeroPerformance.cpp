...
namespace tigl
{
    namespace generated
    {
        CPACSGlobalAeroPerformance::CPACSGlobalAeroPerformance(){}
        CPACSGlobalAeroPerformance::~CPACSGlobalAeroPerformance() {}
        
        void CPACSGlobalAeroPerformance::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSGlobalAeroPerformance::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        bool CPACSGlobalAeroPerformance::HasReference() const
        {
            return static_cast<bool>(m_reference);
        }
        
        const CPACSReference& CPACSGlobalAeroPerformance::GetReference() const
        {
            return *m_reference;
        }
        
        CPACSReference& CPACSGlobalAeroPerformance::GetReference()
        {
            return *m_reference;
        }
        
        const CPACSAeroPerformanceMaps& CPACSGlobalAeroPerformance::GetAeroPerformanceMaps() const
        {
            return m_aeroPerformanceMaps;
        }
        
        CPACSAeroPerformanceMaps& CPACSGlobalAeroPerformance::GetAeroPerformanceMaps()
        {
            return m_aeroPerformanceMaps;
        }
