...
namespace tigl
{
    namespace generated
    {
        CPACSMInstrumentPanel::CPACSMInstrumentPanel(){}
        CPACSMInstrumentPanel::~CPACSMInstrumentPanel() {}
        
        void CPACSMInstrumentPanel::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMInstrumentPanel::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMInstrumentPanel::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMInstrumentPanel::GetMassDescription()
        {
            return m_massDescription;
        }
