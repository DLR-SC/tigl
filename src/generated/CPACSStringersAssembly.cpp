    ...
    namespace generated
    {
        ...
        void CPACSStringersAssembly::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            ...
            if (tixihelper::TixiCheckElement(tixiHandle, xpath + "/stringer")) {
                tixihelper::TixiReadElements(tixiHandle, xpath + "/stringer", m_stringer);
            }
        ...
        void CPACSStringersAssembly::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            ...
            tixihelper::TixiSaveElements(tixiHandle, xpath + "/stringer", m_stringer);
            
        }
        
        const std::vector<unique_ptr<CPACSStringer>>& CPACSStringersAssembly::GetStringer() const
        {
            return m_stringer;
        }
        
        std::vector<unique_ptr<CPACSStringer>>& CPACSStringersAssembly::GetStringer()
        {
            return m_stringer;
        }
