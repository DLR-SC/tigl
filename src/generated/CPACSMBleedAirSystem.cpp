...
namespace tigl
{
    namespace generated
    {
        CPACSMBleedAirSystem::CPACSMBleedAirSystem(){}
        CPACSMBleedAirSystem::~CPACSMBleedAirSystem() {}
        
        void CPACSMBleedAirSystem::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMBleedAirSystem::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMBleedAirSystem::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMBleedAirSystem::GetMassDescription()
        {
            return m_massDescription;
        }
