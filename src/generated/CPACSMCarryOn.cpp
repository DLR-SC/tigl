...
namespace tigl
{
    namespace generated
    {
        CPACSMCarryOn::CPACSMCarryOn(){}
        CPACSMCarryOn::~CPACSMCarryOn() {}
        
        void CPACSMCarryOn::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMCarryOn::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMCarryOn::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMCarryOn::GetMassDescription()
        {
            return m_massDescription;
        }
