...
namespace tigl
{
    namespace generated
    {
        CPACSMPassenger::CPACSMPassenger(){}
        CPACSMPassenger::~CPACSMPassenger() {}
        
        void CPACSMPassenger::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMPassenger::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMPassenger::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMPassenger::GetMassDescription()
        {
            return m_massDescription;
        }
