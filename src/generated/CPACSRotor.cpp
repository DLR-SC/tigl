...
namespace generated
{
    CPACSRotor::CPACSRotor(CCPACSRotors* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_transformation(reinterpret_cast<CCPACSRotor*>(this), m_uidMgr)
    ...
    const CTiglUIDObject* CPACSRotor::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSRotor::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    const CTiglUIDObject* CPACSRotor::GetNextUIDObject() const
    {
        return this;
    }

    void CPACSRotor::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
