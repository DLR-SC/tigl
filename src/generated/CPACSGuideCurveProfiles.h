...
namespace tigl
{
    ...
    namespace generated
    {
        ...
        public:
            ...
            TIGL_EXPORT const std::vector<unique_ptr<CCPACSGuideCurveProfile> >& GetGuideCurveProfiles() const;
            TIGL_EXPORT std::vector<unique_ptr<CCPACSGuideCurveProfile> >& GetGuideCurveProfiles();
