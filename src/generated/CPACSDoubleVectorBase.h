...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSDoubleVectorBase(CPACSCabinAisle* parent);
        TIGL_EXPORT CPACSDoubleVectorBase(CPACSCabinGeometry* parent);
        TIGL_EXPORT CPACSDoubleVectorBase(CPACSCabinGeometryContour* parent);
        TIGL_EXPORT CPACSDoubleVectorBase(CPACSCabinSpace* parent);
        ...
        P* GetParent()
        {
            static_assert(std::is_same<P, CPACSCabinAisle>::value || std::is_same<P, CPACSCabinGeometry>::value || std::is_same<P, CPACSCabinGeometryContour>::value || std::is_same<P, CPACSCabinSpace>::value, "template argument for P is not a parent class of CPACSDoubleVectorBase");
            if (!IsParent<P>()) {
