...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSEtaXsiRelHeightPoint(CCPACSWingSparPosition* parent);
...
// CPACSEtaXsiRelHeightPoint is customized, use type CCPACSEtaXsiRelHeightPoint directly
} // namespace tigl
