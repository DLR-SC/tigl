...
namespace tigl
{
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSAlignmentStructMember();
            ...
            TIGL_EXPORT bool HasOffsetLocX() const;
            TIGL_EXPORT const double& GetOffsetLocX() const;
            TIGL_EXPORT void SetOffsetLocX(const double& value);
