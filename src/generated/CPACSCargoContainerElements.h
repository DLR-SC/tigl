...
namespace generated
{
    ...
    /// @brief Cargo container elements
    /// 
    ...
    {
    public:
        TIGL_EXPORT CPACSCargoContainerElements(CPACSDeckElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSCargoContainerElements();
        ...
        TIGL_EXPORT virtual const std::vector<std::unique_ptr<CPACSVehicleElementBase>>& GetCargoContainerElements() const;
        TIGL_EXPORT virtual std::vector<std::unique_ptr<CPACSVehicleElementBase>>& GetCargoContainerElements();
    ...
    private:
        ...
        CPACSCargoContainerElements& operator=(const CPACSCargoContainerElements&) = delete;

        CPACSCargoContainerElements(CPACSCargoContainerElements&&) = delete;
        CPACSCargoContainerElements& operator=(CPACSCargoContainerElements&&) = delete;
    };
} // namespace generated
