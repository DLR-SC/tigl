...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const boost::optional<std::string>& GetSectionUID_choice4() const;
        TIGL_EXPORT virtual void SetSectionUID_choice4(const boost::optional<std::string>& value);
