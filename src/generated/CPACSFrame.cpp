...
namespace generated
{
    ...
    const CTiglUIDObject* CPACSFrame::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSFrame::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    {
        m_framePositions.push_back(std::make_unique<CCPACSFuselageStringerFramePosition>(reinterpret_cast<CCPACSFrame*>(this), m_uidMgr));
