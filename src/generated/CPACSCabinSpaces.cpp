...
namespace generated
{
    CPACSCabinSpaces::CPACSCabinSpaces(CCPACSDecksDeck* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSDecksDeck* CPACSCabinSpaces::GetParent() const
    {
        return m_parent;
    }

    CCPACSDecksDeck* CPACSCabinSpaces::GetParent()
    {
        return m_parent;
    }
