...
namespace generated
{
    ...
    {
        if (m_uidMgr) {
            if (m_ribDefinitionUID_choice1 && !m_ribDefinitionUID_choice1->empty()) m_uidMgr->TryUnregisterReference(*m_ribDefinitionUID_choice1, *this);
        }
    }
    ...
    const CTiglUIDObject* CPACSControlSurfaceSkinCutOutBorder::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSControlSurfaceSkinCutOutBorder::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSControlSurfaceSkinCutOutBorder::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/ribDefinitionUID")) {
            ...
            if (m_uidMgr && !m_ribDefinitionUID_choice1->empty()) m_uidMgr->RegisterReference(*m_ribDefinitionUID_choice1, *this);
        }
    ...
    const CTiglUIDObject* CPACSControlSurfaceSkinCutOutBorder::GetNextUIDObject() const
    {
        return GetNextUIDParent();
    }

    void CPACSControlSurfaceSkinCutOutBorder::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
        if (m_ribDefinitionUID_choice1 && *m_ribDefinitionUID_choice1 == oldUid) {
            m_ribDefinitionUID_choice1 = newUid;
        }
    }
