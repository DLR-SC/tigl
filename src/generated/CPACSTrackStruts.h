...
namespace generated
{
    class CPACSTrackStrut;
    class CPACSTrackStructure;

    // This class is used in:
    // CPACSTrackStructure

    /// @brief Definition of the struts of a control surface track.
    /// 
    ...
    {
    public:
        TIGL_EXPORT CPACSTrackStruts(CPACSTrackStructure* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSTrackStruts();
        ...
        TIGL_EXPORT virtual const std::vector<std::unique_ptr<CPACSTrackStrut>>& GetStruts() const;
    ...
    private:
        CPACSTrackStruts(const CPACSTrackStruts&) = delete;
        CPACSTrackStruts& operator=(const CPACSTrackStruts&) = delete;

        CPACSTrackStruts(CPACSTrackStruts&&) = delete;
        CPACSTrackStruts& operator=(CPACSTrackStruts&&) = delete;
    };
} // namespace generated
