...
namespace tigl
{
    namespace generated
    {
        ...
        bool CPACSSpoiler::HasDescription() const
        {
            return static_cast<bool>(m_description);
        }
        
        const std::string& CPACSSpoiler::GetDescription() const
        {
            return *m_description;
        }
        
        void CPACSSpoiler::SetDescription(const std::string& value)
        {
            m_description = value;
        }
        ...
        bool CPACSSpoiler::HasWingCutOut() const
        {
            return static_cast<bool>(m_wingCutOut);
        }
        
        const CPACSControlSurfaceWingCutOut& CPACSSpoiler::GetWingCutOut() const
        {
            return *m_wingCutOut;
        }
        
        CPACSControlSurfaceWingCutOut& CPACSSpoiler::GetWingCutOut()
        {
            return *m_wingCutOut;
        }
        
        bool CPACSSpoiler::HasStructure() const
        {
            return static_cast<bool>(m_structure);
        }
        
        const CCPACSWingCSStructure& CPACSSpoiler::GetStructure() const
        {
            return *m_structure;
        }
        
        CCPACSWingCSStructure& CPACSSpoiler::GetStructure()
        {
            return *m_structure;
        }
        ...
        bool CPACSSpoiler::HasTracks() const
        {
            return static_cast<bool>(m_tracks);
        }
        
        const CPACSControlSurfaceTracks& CPACSSpoiler::GetTracks() const
        {
            return *m_tracks;
        }
        
        CPACSControlSurfaceTracks& CPACSSpoiler::GetTracks()
        {
            return *m_tracks;
        }
        
        bool CPACSSpoiler::HasActuators() const
        {
            return static_cast<bool>(m_actuators);
        }
        
        const CPACSControlSurfaceActuators& CPACSSpoiler::GetActuators() const
        {
            return *m_actuators;
        }
        
        CPACSControlSurfaceActuators& CPACSSpoiler::GetActuators()
        {
            return *m_actuators;
        }
