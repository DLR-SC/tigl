...
namespace tigl
{
    namespace generated
    {
        CPACSMBulkCargo::CPACSMBulkCargo(){}
        CPACSMBulkCargo::~CPACSMBulkCargo() {}
        
        void CPACSMBulkCargo::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMBulkCargo::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMBulkCargo::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMBulkCargo::GetMassDescription()
        {
            return m_massDescription;
        }
