...
namespace tigl
{
    namespace generated
    {
        CPACSMEmptyULD::CPACSMEmptyULD(){}
        CPACSMEmptyULD::~CPACSMEmptyULD() {}
        
        void CPACSMEmptyULD::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMEmptyULD::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMEmptyULD::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMEmptyULD::GetMassDescription()
        {
            return m_massDescription;
        }
