...
namespace tigl
{
    namespace generated
    {
        CPACSRadiativeForcing::CPACSRadiativeForcing(){}
        CPACSRadiativeForcing::~CPACSRadiativeForcing() {}
        
        void CPACSRadiativeForcing::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            // read element total
        ...
        void CPACSRadiativeForcing::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            // write element total
        ...
        const CCPACSStringVector& CPACSRadiativeForcing::GetTotal() const
        {
            return m_total;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetTotal()
        {
            return m_total;
        }
        
        const CCPACSStringVector& CPACSRadiativeForcing::GetCO2() const
        {
            return m_cO2;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetCO2()
        {
            return m_cO2;
        }
        
        const CCPACSStringVector& CPACSRadiativeForcing::GetH2O() const
        {
            return m_h2O;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetH2O()
        {
            return m_h2O;
        }
        
        const CCPACSStringVector& CPACSRadiativeForcing::GetO3() const
        {
            return m_o3;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetO3()
        {
            return m_o3;
        }
        
        const CCPACSStringVector& CPACSRadiativeForcing::GetCH4() const
        {
            return m_cH4;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetCH4()
        {
            return m_cH4;
        }
        
        const CCPACSStringVector& CPACSRadiativeForcing::GetCont() const
        {
            return m_cont;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetCont()
        {
            return m_cont;
        }
        
        const CCPACSStringVector& CPACSRadiativeForcing::GetPmo() const
        {
            return m_pmo;
        }
        
        CCPACSStringVector& CPACSRadiativeForcing::GetPmo()
        {
            return m_pmo;
        }
