...
namespace tigl
{
    namespace generated
    {
        CPACSMAuxillaryPowerUnit::CPACSMAuxillaryPowerUnit(){}
        CPACSMAuxillaryPowerUnit::~CPACSMAuxillaryPowerUnit() {}
        
        void CPACSMAuxillaryPowerUnit::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMAuxillaryPowerUnit::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMAuxillaryPowerUnit::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMAuxillaryPowerUnit::GetMassDescription()
        {
            return m_massDescription;
        }
