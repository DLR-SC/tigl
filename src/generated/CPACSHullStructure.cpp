...
namespace generated
{
    CPACSHullStructure::CPACSHullStructure(CPACSHull* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CPACSHull* CPACSHullStructure::GetParent() const
    {
        return m_parent;
    }

    CPACSHull* CPACSHullStructure::GetParent()
    {
        return m_parent;
    }
