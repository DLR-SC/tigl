...
namespace generated
{
    CPACSEngines::CPACSEngines(CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
    }
    ...
    void CPACSEngines::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/engine")) {
            tixi::TixiReadElements(tixiHandle, xpath + "/engine", m_engines, 1, tixi::xsdUnbounded, m_uidMgr);
        }
    ...
    {
        m_engines.push_back(make_unique<CPACSEngine>(m_uidMgr));
