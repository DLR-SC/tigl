...
namespace tigl
{
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSPointListXY();
            TIGL_EXPORT virtual ~CPACSPointListXY();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSPointXY>>& GetPoint() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSPointXY>>& GetPoint();
            
        protected:
            std::vector<unique_ptr<CPACSPointXY>> m_point;
    ...
    #ifdef CPP11
    using CCPACSPointListXY = generated::CPACSPointListXY;
    #else
    typedef generated::CPACSPointListXY CCPACSPointListXY;
    #endif
    
    using generated::CPACSPointXY;
}
