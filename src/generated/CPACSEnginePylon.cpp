...
namespace generated
{
    ...
    const CTiglUIDObject* CPACSEnginePylon::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSEnginePylon::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSEnginePylon::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/positionings")) {
            m_positionings = boost::in_place(reinterpret_cast<CCPACSEnginePylon*>(this), m_uidMgr);
            try {
    ...
    const CTiglUIDObject* CPACSEnginePylon::GetNextUIDObject() const
    {
        return this;
    }

    void CPACSEnginePylon::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
