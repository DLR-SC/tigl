...
namespace tigl
{
    namespace generated
    {
        ...
        // generated from /xsd:schema/xsd:complexType[283]
        class CPACSDoorSurroundStructuresAssembly
        {
        public:
            TIGL_EXPORT CPACSDoorSurroundStructuresAssembly();
            TIGL_EXPORT virtual ~CPACSDoorSurroundStructuresAssembly();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSDoorSurroundStructurePosition>>& GetDoorSurroundStructure() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSDoorSurroundStructurePosition>>& GetDoorSurroundStructure();
            
        protected:
            std::vector<unique_ptr<CPACSDoorSurroundStructurePosition>> m_doorSurroundStructure;
    ...
    using generated::CPACSDoorSurroundStructurePosition;
}
