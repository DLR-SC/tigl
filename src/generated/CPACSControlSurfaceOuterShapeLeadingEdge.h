...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const CPACSControlSurfaceBorderLeadingEdge& GetInnerBorder() const;
        TIGL_EXPORT virtual CPACSControlSurfaceBorderLeadingEdge& GetInnerBorder();

        TIGL_EXPORT virtual const CPACSControlSurfaceBorderLeadingEdge& GetOuterBorder() const;
        TIGL_EXPORT virtual CPACSControlSurfaceBorderLeadingEdge& GetOuterBorder();
