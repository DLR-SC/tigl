...
namespace tigl
{
    namespace generated
    {
        CPACSMDeIcing::CPACSMDeIcing(){}
        CPACSMDeIcing::~CPACSMDeIcing() {}
        
        void CPACSMDeIcing::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMDeIcing::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMDeIcing::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMDeIcing::GetMassDescription()
        {
            return m_massDescription;
        }
