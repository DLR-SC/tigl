...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSFlightPoints(CPACSVehicles* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSFlightPoints();
    ...
    private:
        CPACSFlightPoints(const CPACSFlightPoints&) = delete;
        CPACSFlightPoints& operator=(const CPACSFlightPoints&) = delete;

        CPACSFlightPoints(CPACSFlightPoints&&) = delete;
        CPACSFlightPoints& operator=(CPACSFlightPoints&&) = delete;
    };
} // namespace generated
