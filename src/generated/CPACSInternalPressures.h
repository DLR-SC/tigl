...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual size_t GetInternalPressureIndex(const std::string& UID) const;
        ...
        TIGL_EXPORT virtual const CPACSInternalPressure& GetInternalPressure(const std::string& UID) const;
        TIGL_EXPORT virtual CPACSInternalPressure& GetInternalPressure(const std::string& UID);
