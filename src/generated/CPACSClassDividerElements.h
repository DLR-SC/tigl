...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSClassDividerElements(CPACSDeckElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSClassDividerElements();
    ...
    private:
        ...
        CPACSClassDividerElements& operator=(const CPACSClassDividerElements&) = delete;

        CPACSClassDividerElements(CPACSClassDividerElements&&) = delete;
        CPACSClassDividerElements& operator=(CPACSClassDividerElements&&) = delete;
    };
} // namespace generated
