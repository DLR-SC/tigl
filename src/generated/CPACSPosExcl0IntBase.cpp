...
namespace generated
{
    CPACSPosExcl0IntBase::CPACSPosExcl0IntBase(CPACSGalleyElement* parent)
        : m_value(0)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    CPACSPosExcl0IntBase::CPACSPosExcl0IntBase(CPACSSeatElement* parent)
        : m_value(0)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    CPACSPosExcl0IntBase::~CPACSPosExcl0IntBase()
    {
    }

    const CTiglUIDObject* CPACSPosExcl0IntBase::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSPosExcl0IntBase::GetNextUIDParent()
    {
        if (m_parent) {
            if (IsParent<CPACSGalleyElement>()) {
                return GetParent<CPACSGalleyElement>();
    ...
    void CPACSPosExcl0IntBase::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
    ...
    void CPACSPosExcl0IntBase::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
    {
    ...
    const boost::optional<std::string>& CPACSPosExcl0IntBase::GetExternalDataNodePath() const
    {
        return m_externalDataNodePath;
    }

    void CPACSPosExcl0IntBase::SetExternalDataNodePath(const boost::optional<std::string>& value)
    {
        m_externalDataNodePath = value;
    }

    const boost::optional<std::string>& CPACSPosExcl0IntBase::GetExternalFileName() const
    {
        return m_externalFileName;
    }

    void CPACSPosExcl0IntBase::SetExternalFileName(const boost::optional<std::string>& value)
    {
        m_externalFileName = value;
    }

    const boost::optional<std::string>& CPACSPosExcl0IntBase::GetExternalDataDirectory() const
    {
        return m_externalDataDirectory;
    }

    void CPACSPosExcl0IntBase::SetExternalDataDirectory(const boost::optional<std::string>& value)
    {
        m_externalDataDirectory = value;
    }

    const int& CPACSPosExcl0IntBase::GetValue() const
    {
        return m_value;
    }

    void CPACSPosExcl0IntBase::SetValue(const int& value)
    {
        m_value = value;
    }
