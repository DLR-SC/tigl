...
namespace generated
{
    CPACSControlSurfaceOuterShapeLeadingEdge::CPACSControlSurfaceOuterShapeLeadingEdge(CCPACSLeadingEdgeDevice* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_innerBorder(reinterpret_cast<CCPACSControlSurfaceOuterShapeLeadingEdge*>(this), m_uidMgr)
        , m_outerBorder(reinterpret_cast<CCPACSControlSurfaceOuterShapeLeadingEdge*>(this), m_uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    }
    ...
    void CPACSControlSurfaceOuterShapeLeadingEdge::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/intermediateAirfoils")) {
            m_intermediateAirfoils = boost::in_place(reinterpret_cast<CCPACSControlSurfaceOuterShapeLeadingEdge*>(this), m_uidMgr);
            try {
    ...
    const CCPACSControlSurfaceBorderLeadingEdge& CPACSControlSurfaceOuterShapeLeadingEdge::GetInnerBorder() const
    {
        return m_innerBorder;
    }

    CCPACSControlSurfaceBorderLeadingEdge& CPACSControlSurfaceOuterShapeLeadingEdge::GetInnerBorder()
    {
        return m_innerBorder;
    }

    const CCPACSControlSurfaceBorderLeadingEdge& CPACSControlSurfaceOuterShapeLeadingEdge::GetOuterBorder() const
    {
        return m_outerBorder;
    }

    CCPACSControlSurfaceBorderLeadingEdge& CPACSControlSurfaceOuterShapeLeadingEdge::GetOuterBorder()
    {
        return m_outerBorder;
    }
