...
namespace tigl
{
    namespace generated
    {
        CPACSMULDContent::CPACSMULDContent(){}
        CPACSMULDContent::~CPACSMULDContent() {}
        
        void CPACSMULDContent::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMULDContent::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMULDContent::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMULDContent::GetMassDescription()
        {
            return m_massDescription;
        }
