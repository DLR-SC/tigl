...
namespace generated
{
    CPACSWingCell::CPACSWingCell(CCPACSWingCells* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_skin(reinterpret_cast<CCPACSWingCell*>(this), m_uidMgr)
        , m_positioningLeadingEdge(reinterpret_cast<CCPACSWingCell*>(this), m_uidMgr)
        , m_positioningTrailingEdge(reinterpret_cast<CCPACSWingCell*>(this), m_uidMgr)
        , m_positioningInnerBorder(reinterpret_cast<CCPACSWingCell*>(this), m_uidMgr)
        , m_positioningOuterBorder(reinterpret_cast<CCPACSWingCell*>(this), m_uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    }
    ...
    const CTiglUIDObject* CPACSWingCell::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSWingCell::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
