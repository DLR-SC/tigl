...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT CPACSControlSurfacePath(CCPACSSpoiler* parent, CTiglUIDManager* uidMgr);
        ...
        P* GetParent()
        {
            static_assert(std::is_same<P, CCPACSLeadingEdgeDevice>::value || std::is_same<P, CCPACSSpoiler>::value || std::is_same<P, CCPACSTrailingEdgeDevice>::value, "template argument for P is not a parent class of CPACSControlSurfacePath");
            if (!IsParent<P>()) {
