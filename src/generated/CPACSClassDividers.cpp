...
namespace generated
{
    CPACSClassDividers::CPACSClassDividers(CCPACSDecksDeck* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CCPACSDecksDeck* CPACSClassDividers::GetParent() const
    {
        return m_parent;
    }

    CCPACSDecksDeck* CPACSClassDividers::GetParent()
    {
        return m_parent;
    }
