...
namespace tigl
{
    namespace generated
    {
        CPACSMEngineControl::CPACSMEngineControl(){}
        CPACSMEngineControl::~CPACSMEngineControl() {}
        
        void CPACSMEngineControl::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMEngineControl::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMEngineControl::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMEngineControl::GetMassDescription()
        {
            return m_massDescription;
        }
