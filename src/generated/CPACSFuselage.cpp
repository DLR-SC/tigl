...
namespace generated
{
    CPACSFuselage::CPACSFuselage(CPACSFuselages* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    ...
    const CPACSFuselages* CPACSFuselage::GetParent() const
    {
        return m_parent;
    }

    CPACSFuselages* CPACSFuselage::GetParent()
    {
        return m_parent;
    }

    const CTiglUIDObject* CPACSFuselage::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSFuselage::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSFuselage::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/positionings")) {
            m_positionings = boost::in_place(reinterpret_cast<CCPACSFuselage*>(this), m_uidMgr);
            try {
    ...
    const CPACSFuselageSections& CPACSFuselage::GetSections() const
    {
        return m_sections;
    }

    CPACSFuselageSections& CPACSFuselage::GetSections()
    {
        return m_sections;
    }
    ...
    void CPACSFuselage::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
