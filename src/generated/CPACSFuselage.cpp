...
namespace generated
{
    ...
    const boost::optional<CPACSLoftContinuity>& CPACSFuselage::GetLoftContinuity() const
    {
        return m_loftContinuity;
    }

    void CPACSFuselage::SetLoftContinuity(const boost::optional<CPACSLoftContinuity>& value)
    {
