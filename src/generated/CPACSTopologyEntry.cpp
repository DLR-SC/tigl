...
#include "CPACSTopologyEntry.h"

namespace tigl
{
    namespace generated
    {
        CPACSTopologyEntry::CPACSTopologyEntry(){}
        CPACSTopologyEntry::~CPACSTopologyEntry() {}
        
        void CPACSTopologyEntry::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSTopologyEntry::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const std::string& CPACSTopologyEntry::GetDamPoint1UID() const
        {
            return m_damPoint1UID;
        }
        
        void CPACSTopologyEntry::SetDamPoint1UID(const std::string& value)
        {
            m_damPoint1UID = value;
        }
        
        const std::string& CPACSTopologyEntry::GetDamPoint2UID() const
        {
            return m_damPoint2UID;
        }
        
        void CPACSTopologyEntry::SetDamPoint2UID(const std::string& value)
        {
            m_damPoint2UID = value;
        }
        
        bool CPACSTopologyEntry::HasRotation() const
        {
            return static_cast<bool>(m_rotation);
        }
        
        const CPACSPointXYZ& CPACSTopologyEntry::GetRotation() const
        {
            return *m_rotation;
        }
        
        CPACSPointXYZ& CPACSTopologyEntry::GetRotation()
        {
            return *m_rotation;
        }
        
        bool CPACSTopologyEntry::HasStiffness() const
        {
            return static_cast<bool>(m_stiffness);
        }
        
        const CPACSStiffness& CPACSTopologyEntry::GetStiffness() const
        {
            return *m_stiffness;
        }
        
        CPACSStiffness& CPACSTopologyEntry::GetStiffness()
        {
            return *m_stiffness;
        }
