...
namespace generated
{
    CPACSStructuralMount::CPACSStructuralMount(CPACSFuselageStructuralMounts* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
        , m_blockedDOF(0)
    ...
    const CPACSFuselageStructuralMounts* CPACSStructuralMount::GetParent() const
    {
        return m_parent;
    }

    CPACSFuselageStructuralMounts* CPACSStructuralMount::GetParent()
    {
        return m_parent;
    }
    ...
    void CPACSStructuralMount::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElementHasTextContent(tixiHandle, xpath + "/blockedDOF")) {
        ...
        if (tixi::TixiCheckElementHasTextContent(tixiHandle, xpath + "/takeOnlyEndPoints")) {
        ...
        if (tixi::TixiCheckElementHasTextContent(tixiHandle, xpath + "/fromStructureUID")) {
        ...
        if (tixi::TixiCheckElementHasTextContent(tixiHandle, xpath + "/fromStructureCounter")) {
            m_fromStructureCounter = tixi::TixiGetElement<int>(tixiHandle, xpath + "/fromStructureCounter");
        }

        // read element toStructureUID
        if (tixi::TixiCheckElementHasTextContent(tixiHandle, xpath + "/toStructureUID")) {
        ...
        if (tixi::TixiCheckElementHasTextContent(tixiHandle, xpath + "/toStructureCounter")) {
