...
namespace generated
{
    ...
    /// 
    /// 
    class CPACSElectricMotor : public CTiglReqUIDObject
    {
    public:
        TIGL_EXPORT CPACSElectricMotor(CPACSElectricMotors* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSElectricMotor();

        TIGL_EXPORT CPACSElectricMotors* GetParent();

        TIGL_EXPORT const CPACSElectricMotors* GetParent() const;
    ...
    private:
        CPACSElectricMotor(const CPACSElectricMotor&) = delete;
        CPACSElectricMotor& operator=(const CPACSElectricMotor&) = delete;

        CPACSElectricMotor(CPACSElectricMotor&&) = delete;
        CPACSElectricMotor& operator=(CPACSElectricMotor&&) = delete;
    };
} // namespace generated
