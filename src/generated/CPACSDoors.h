...
namespace tigl
{
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSDoors();
            TIGL_EXPORT virtual ~CPACSDoors();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSDoorCutOut>>& GetDoor() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSDoorCutOut>>& GetDoor();
            
        protected:
            std::vector<unique_ptr<CPACSDoorCutOut>> m_door;
    ...
    #else
    typedef generated::CPACSDoors CCPACSDoors;
    #endif
    
    using generated::CPACSDoorCutOut;
}
