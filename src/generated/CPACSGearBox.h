...
namespace generated
{
    ...
    /// 
    /// 
    class CPACSGearBox : public CTiglReqUIDObject
    {
    public:
        TIGL_EXPORT CPACSGearBox(CPACSGearBoxes* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSGearBox();

        TIGL_EXPORT CPACSGearBoxes* GetParent();

        TIGL_EXPORT const CPACSGearBoxes* GetParent() const;
    ...
    private:
        CPACSGearBox(const CPACSGearBox&) = delete;
        CPACSGearBox& operator=(const CPACSGearBox&) = delete;

        CPACSGearBox(CPACSGearBox&&) = delete;
        CPACSGearBox& operator=(CPACSGearBox&&) = delete;
    };
} // namespace generated
