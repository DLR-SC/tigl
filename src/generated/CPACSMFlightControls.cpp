...
namespace tigl
{
    namespace generated
    {
        CPACSMFlightControls::CPACSMFlightControls(){}
        CPACSMFlightControls::~CPACSMFlightControls() {}
        
        void CPACSMFlightControls::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSMFlightControls::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericMass& CPACSMFlightControls::GetMassDescription() const
        {
            return m_massDescription;
        }
        
        CPACSGenericMass& CPACSMFlightControls::GetMassDescription()
        {
            return m_massDescription;
        }
