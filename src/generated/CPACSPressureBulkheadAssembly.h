...
namespace tigl
{
    namespace generated
    {
        ...
        // generated from /xsd:schema/xsd:complexType[701]
        class CPACSPressureBulkheadAssembly
        {
        public:
            TIGL_EXPORT CPACSPressureBulkheadAssembly();
            TIGL_EXPORT virtual ~CPACSPressureBulkheadAssembly();
            
            TIGL_EXPORT virtual void ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath);
            TIGL_EXPORT virtual void WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const;
            
            TIGL_EXPORT const std::vector<unique_ptr<CPACSPressureBulkheadAssemblyPosition>>& GetPressureBulkhead() const;
            TIGL_EXPORT std::vector<unique_ptr<CPACSPressureBulkheadAssemblyPosition>>& GetPressureBulkhead();
            
        protected:
            std::vector<unique_ptr<CPACSPressureBulkheadAssemblyPosition>> m_pressureBulkhead;
    ...
    #ifdef CPP11
    using CCPACSPressureBulkheadAssembly = generated::CPACSPressureBulkheadAssembly;
    #else
    typedef generated::CPACSPressureBulkheadAssembly CCPACSPressureBulkheadAssembly;
    #endif
    
    using generated::CPACSPressureBulkheadAssemblyPosition;
}
