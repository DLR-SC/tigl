...
namespace tigl
{
    ...
    namespace generated
    {
        ...
        {
        public:
            TIGL_EXPORT CPACSGenericGeometryComponents(CCPACSAircraftModel* parent);
            ...
            TIGL_EXPORT const std::vector<unique_ptr<CCPACSExternalObject> >& GetGenericGeometryComponents() const;
            TIGL_EXPORT std::vector<unique_ptr<CCPACSExternalObject> >& GetGenericGeometryComponents();
