...
namespace tigl
{
    namespace generated
    {
        CPACSCostFuselages::CPACSCostFuselages(){}
        CPACSCostFuselages::~CPACSCostFuselages() {}
        
        void CPACSCostFuselages::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSCostFuselages::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const CPACSGenericCost& CPACSCostFuselages::GetCostDescription() const
        {
            return m_costDescription;
        }
        
        CPACSGenericCost& CPACSCostFuselages::GetCostDescription()
        {
            return m_costDescription;
        }
        
        const std::vector<unique_ptr<CPACSGenericCost>>& CPACSCostFuselages::GetFuselage() const
        {
            return m_fuselage;
        }
        
        std::vector<unique_ptr<CPACSGenericCost>>& CPACSCostFuselages::GetFuselage()
        {
            return m_fuselage;
        }
