...
#include "CPACSZCoupling.h"

namespace tigl
{
    namespace generated
    {
        CPACSZCoupling::CPACSZCoupling(){}
        CPACSZCoupling::~CPACSZCoupling() {}
        
        void CPACSZCoupling::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
            // read attribute uID
        ...
        void CPACSZCoupling::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
            // write attribute uID
        ...
        const std::string& CPACSZCoupling::GetUID() const
        {
            return m_uID;
        }
        
        void CPACSZCoupling::SetUID(const std::string& value)
        {
            m_uID = value;
        }
        
        const std::string& CPACSZCoupling::GetToControlSurfaceUID() const
        {
            return m_toControlSurfaceUID;
        }
        
        void CPACSZCoupling::SetToControlSurfaceUID(const std::string& value)
        {
            m_toControlSurfaceUID = value;
        }
        
        const CCPACSMaterial& CPACSZCoupling::GetMaterial() const
        {
            return m_material;
        }
        
        CCPACSMaterial& CPACSZCoupling::GetMaterial()
        {
            return m_material;
        }
        
        const CPACSInterConnectionStrutAttachment& CPACSZCoupling::GetFromAttachment() const
        {
            return m_fromAttachment;
        }
        
        CPACSInterConnectionStrutAttachment& CPACSZCoupling::GetFromAttachment()
        {
            return m_fromAttachment;
        }
        
        const CPACSInterConnectionStrutAttachment& CPACSZCoupling::GetToAttachment() const
        {
            return m_toAttachment;
        }
        
        CPACSInterConnectionStrutAttachment& CPACSZCoupling::GetToAttachment()
        {
            return m_toAttachment;
        }
