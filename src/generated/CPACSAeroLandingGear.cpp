...
#include "CPACSAeroLandingGear.h"

namespace tigl
{
    namespace generated
    {
        CPACSAeroLandingGear::CPACSAeroLandingGear(){}
        CPACSAeroLandingGear::~CPACSAeroLandingGear() {}
        
        void CPACSAeroLandingGear::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
        {
        ...
        void CPACSAeroLandingGear::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
        {
        ...
        const std::string& CPACSAeroLandingGear::GetLandingGearUID() const
        {
            return m_landingGearUID;
        }
        
        void CPACSAeroLandingGear::SetLandingGearUID(const std::string& value)
        {
            m_landingGearUID = value;
        }
        
        const CCPACSStringVector& CPACSAeroLandingGear::GetRelDeflection() const
        {
            return m_relDeflection;
        }
        
        CCPACSStringVector& CPACSAeroLandingGear::GetRelDeflection()
        {
            return m_relDeflection;
        }
        
        bool CPACSAeroLandingGear::HasDcfx() const
        {
            return static_cast<bool>(m_dcfx);
        }
        
        const CPACSStringArrayBase& CPACSAeroLandingGear::GetDcfx() const
        {
            return *m_dcfx;
        }
        
        CPACSStringArrayBase& CPACSAeroLandingGear::GetDcfx()
        {
            return *m_dcfx;
        }
        
        bool CPACSAeroLandingGear::HasDcfy() const
        {
            return static_cast<bool>(m_dcfy);
        }
        
        const CPACSStringArrayBase& CPACSAeroLandingGear::GetDcfy() const
        {
            return *m_dcfy;
        }
        
        CPACSStringArrayBase& CPACSAeroLandingGear::GetDcfy()
        {
            return *m_dcfy;
        }
        
        bool CPACSAeroLandingGear::HasDcfz() const
        {
            return static_cast<bool>(m_dcfz);
        }
        
        const CPACSStringArrayBase& CPACSAeroLandingGear::GetDcfz() const
        {
            return *m_dcfz;
        }
        
        CPACSStringArrayBase& CPACSAeroLandingGear::GetDcfz()
        {
            return *m_dcfz;
        }
        
        bool CPACSAeroLandingGear::HasDcmx() const
        {
            return static_cast<bool>(m_dcmx);
        }
        
        const CPACSStringArrayBase& CPACSAeroLandingGear::GetDcmx() const
        {
            return *m_dcmx;
        }
        
        CPACSStringArrayBase& CPACSAeroLandingGear::GetDcmx()
        {
            return *m_dcmx;
        }
        
        bool CPACSAeroLandingGear::HasDcmy() const
        {
            return static_cast<bool>(m_dcmy);
        }
        
        const CPACSStringArrayBase& CPACSAeroLandingGear::GetDcmy() const
        {
            return *m_dcmy;
        }
        
        CPACSStringArrayBase& CPACSAeroLandingGear::GetDcmy()
        {
            return *m_dcmy;
        }
        
        bool CPACSAeroLandingGear::HasDcmz() const
        {
            return static_cast<bool>(m_dcmz);
        }
        
        const CPACSStringArrayBase& CPACSAeroLandingGear::GetDcmz() const
        {
            return *m_dcmz;
        }
        
        CPACSStringArrayBase& CPACSAeroLandingGear::GetDcmz()
        {
            return *m_dcmz;
        }
