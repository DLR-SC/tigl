...
namespace generated
{
    ...
    const CTiglUIDObject* CPACSFuselageSegment::GetNextUIDParent() const
    {
        if (m_parent) {
    ...
    CTiglUIDObject* CPACSFuselageSegment::GetNextUIDParent()
    {
        if (m_parent) {
            return m_parent->GetNextUIDParent();
        }
    ...
    void CPACSFuselageSegment::ReadCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath)
    {
        ...
        if (tixi::TixiCheckElement(tixiHandle, xpath + "/guideCurves")) {
            m_guideCurves = boost::in_place(reinterpret_cast<CCPACSFuselageSegment*>(this), m_uidMgr);
            try {
    ...
    const CTiglUIDObject* CPACSFuselageSegment::GetNextUIDObject() const
    {
        return this;
    }

    void CPACSFuselageSegment::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
