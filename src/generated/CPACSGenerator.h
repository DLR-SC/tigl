...
namespace generated
{
    ...
    /// 
    /// 
    class CPACSGenerator : public CTiglReqUIDObject
    {
    public:
        TIGL_EXPORT CPACSGenerator(CPACSGenerators* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSGenerator();

        TIGL_EXPORT CPACSGenerators* GetParent();

        TIGL_EXPORT const CPACSGenerators* GetParent() const;
    ...
    private:
        CPACSGenerator(const CPACSGenerator&) = delete;
        CPACSGenerator& operator=(const CPACSGenerator&) = delete;

        CPACSGenerator(CPACSGenerator&&) = delete;
        CPACSGenerator& operator=(CPACSGenerator&&) = delete;
    };
} // namespace generated
