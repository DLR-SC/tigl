...
namespace generated
{
    CPACSCellPositioningChordwise::CPACSCellPositioningChordwise(CCPACSWingCell* parent, CTiglUIDManager* uidMgr)
        : m_uidMgr(uidMgr)
    {
        //assert(parent != NULL);
        m_parent = parent;
    ...
    const CTiglUIDObject* CPACSCellPositioningChordwise::GetNextUIDParent() const
    {
        return m_parent;
    }

    CTiglUIDObject* CPACSCellPositioningChordwise::GetNextUIDParent()
    {
        return m_parent;
    }

    CTiglUIDManager& CPACSCellPositioningChordwise::GetUIDManager()
    {
        return *m_uidMgr;
    }

    const CTiglUIDManager& CPACSCellPositioningChordwise::GetUIDManager() const
    {
        return *m_uidMgr;
    }
    ...
    void CPACSCellPositioningChordwise::NotifyUIDChange(const std::string& oldUid, const std::string& newUid)
    {
