...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSGenericFloorElements(CPACSDeckElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSGenericFloorElements();
    ...
    private:
        ...
        CPACSGenericFloorElements& operator=(const CPACSGenericFloorElements&) = delete;

        CPACSGenericFloorElements(CPACSGenericFloorElements&&) = delete;
        CPACSGenericFloorElements& operator=(CPACSGenericFloorElements&&) = delete;
    };
} // namespace generated
