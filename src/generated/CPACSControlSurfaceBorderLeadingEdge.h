...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT CCPACSControlSurfaceOuterShapeLeadingEdge* GetParent();

        TIGL_EXPORT const CCPACSControlSurfaceOuterShapeLeadingEdge* GetParent() const;
...
// CPACSControlSurfaceBorderLeadingEdge is customized, use type CCPACSControlSurfaceBorderLeadingEdge directly
} // namespace tigl
