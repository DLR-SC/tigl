  ...
  const Standard_Boolean theInsertKnots)
{
  ...
  if(iter > aNbIter) SurfTools::USmoothing(theS, theCont, 1.e10);
  ...
  const Standard_Boolean theInsertKnots)
{
  ...
  if(iter > aNbIter) SurfTools::VSmoothing(theS, theCont, 1.e10);
