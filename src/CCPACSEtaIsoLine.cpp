...
CCPACSEtaIsoLine::CCPACSEtaIsoLine(CCPACSWingRibExplicitPositioning* parent)
    : generated::CPACSEtaIsoLine(parent)
{
}

CCPACSEtaIsoLine::CCPACSEtaIsoLine(CCPACSWingRibsPositioning* parent)
    : generated::CPACSEtaIsoLine(parent)
{
}
...
void CCPACSEtaIsoLine::InvalidateParent()
{
    ...
    //    GetParent<CCPACSControlSurfaceBorderTrailingEdge>()->Invalidate();
    //if (IsParent<CCPACSControlSurfaceSkinCutOutBorder>())
    //    GetParent<CCPACSControlSurfaceSkinCutOutBorder>()->Invalidate();
    //if (IsParent<CCPACSControlSurfaceTrackType>())
    //    GetParent<CCPACSControlSurfaceTrackType>()->Invalidate();
    ...
    if (IsParent<CCPACSWingRibExplicitPositioning>())
        GetParent<CCPACSWingRibExplicitPositioning>()->Invalidate();
    if (IsParent<CCPACSWingRibsPositioning>())
        GetParent<CCPACSWingRibsPositioning>()->Invalidate();
}
}
