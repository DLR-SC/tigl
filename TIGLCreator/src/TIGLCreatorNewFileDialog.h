...
#ifndef TIGLCREATORNEWFILEDIALOG_H
#define TIGLCREATORNEWFILEDIALOG_H
...
namespace Ui
{
class TIGLCreatorNewFileDialog;
}
 ...
 * template directory of the TIGLCreatorSettings class.)
 ...
 *
 */
class TIGLCreatorNewFileDialog : public QDialog
{
    Q_OBJECT

public:
    explicit TIGLCreatorNewFileDialog(QWidget* parent = nullptr);
    ~TIGLCreatorNewFileDialog();
...
private:
    Ui::TIGLCreatorNewFileDialog* ui;
    QStringListModel templateListModel;
    QString newCPACSFileName;
};

#endif // TIGLCREATORNEWFILEDIALOG_H
