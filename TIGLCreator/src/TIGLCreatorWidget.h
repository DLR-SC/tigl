...
* Changed: $Id: TIGLCreatorWidget.h 203 2012-09-25 08:47:55Z martinsiggel $
*
...
#ifndef TIGLCREATORWIDGET_H
#define TIGLCREATORWIDGET_H
...
*/
public:
    explicit TIGLCreatorWidget(QWidget*);

    ~TIGLCreatorWidget() override = default;
...
public slots:
    ...
    void addSpotlight(double x, double y, double z, double dx, double dy, double dz);
    void setReset();
...
Q_DECLARE_METATYPE(TIGLCreatorWidget*)

#endif // TIGLCREATORWIDGET_H
