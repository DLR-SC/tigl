...
TIGLScriptEngine::TIGLScriptEngine(TIGLCreatorWindow* app)
    : QObject(app)
{
    ...
    qScriptRegisterMetaType(&engine, qobjectToScriptValue<TIGLCreatorWidget>, objectFromScriptValue<TIGLCreatorWidget>);
    qScriptRegisterMetaType(&engine, qobjectToScriptValue<TIGLCreatorContext>, objectFromScriptValue<TIGLCreatorContext>);
    qScriptRegisterMetaType(&engine, qobjectToScriptValue<TIGLCreatorDocument>, objectFromScriptValue<TIGLCreatorDocument>);
    qScriptRegisterMetaType(&engine, qobjectToScriptValue<TIGLCreatorSettings>, objectFromScriptValue<TIGLCreatorSettings>);
