...
* Changed: $Id: TIGLCreatorDocument.h 226 2012-10-23 19:18:29Z martinsiggel $
*
...
*/
#ifndef TIGLCREATORDOCUMENT_H
#define TIGLCREATORDOCUMENT_H
...
class TIGLCreatorDocument : public QObject
{
    Q_OBJECT
...
public:
    ...
    // Reload the TIGLCreatorDocument form a string that content the tixi content.
...
public slots:
    ...
    void drawFlapsOverlay();

    // Wing slots
    void drawWingProfiles();
    void drawWing(const QString& Uid, bool drawFlaps = false);
...
private: 
    ...
    class TIGLCreatorSelectWingAndFlapStatusDialog* m_flapsDialog;
    ...
    QString myLastFolder; // TODO: synchronize with TIGLCreatorWindow
...
Q_DECLARE_METATYPE(TIGLCreatorDocument*)

#endif // TIGLCREATORDOCUMENT_H
