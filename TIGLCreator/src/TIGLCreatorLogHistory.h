...
#ifndef TIGLCREATORLOGHISTORY_H
#define TIGLCREATORLOGHISTORY_H
...
class TIGLCreatorLogHistory : public tigl::ITiglLogger
{
public:
    ...
    TIGLCreatorLogHistory();

    ~TIGLCreatorLogHistory() override {}
...
protected:
    TIGLCreatorLogHistory(const TIGLCreatorLogHistory&);
    TIGLCreatorLogHistory& operator = (const TIGLCreatorLogHistory&);
