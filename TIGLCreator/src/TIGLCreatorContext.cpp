...
* Changed: $Id: TIGLCreatorContext.cpp 203 2012-09-25 08:47:55Z martinsiggel $
*
...
TIGLCreatorContext::~TIGLCreatorContext()
{

}

Handle(V3d_Viewer)& TIGLCreatorContext::getViewer()
{ 
    return myViewer; 
}
...
\brief    Deletes all objects.
        ...
        No parameters.
*/
void TIGLCreatorContext::deleteAllObjects()
{
...
*/
void TIGLCreatorContext::gridXY  ( void )
{
    myGridColor      = Quantity_NOC_RED4;
...
*/
void TIGLCreatorContext::gridXZ  ( void )
{
...
\brief    Sets the privileged plane to the XY Axis.
 */
void TIGLCreatorContext::gridYZ  ( void )
{
 ...
 */
void TIGLCreatorContext::toggleGrid(bool gridIsOn) 
{
    if (gridIsOn) {
        gridOn();
    }
 ...
 */
void TIGLCreatorContext::gridOn  ( void )
{
...
*/
void TIGLCreatorContext::gridOff ( void )
{
...
*/
void TIGLCreatorContext::gridRect ( void )
{
    myGridType = Aspect_GT_Rectangular;
    myViewer->ActivateGrid( myGridType , myGridMode );
    myViewer->Grid()->SetColors( myGridColor, myGridTenthColor );
...
*/
void TIGLCreatorContext::gridCirc ( void )
{
 ...
 */
void TIGLCreatorContext::wireFrame(bool wireframe) 
{
    if (!myContext.IsNull()) {
...
void TIGLCreatorContext::selectAll()
{
    if (!myContext.IsNull()) {
        AIS_ListOfInteractive aList;
        // deselect all
...
void TIGLCreatorContext::displayShape(const PNamedShape& pshape, bool updateViewer, Quantity_Color color, double transparency)
{
    ...
    //QUndoCommand* command = new TiGLCreator::DrawObjects(myContext, shape, pshape->Name(), updateViewer);
...
void TIGLCreatorContext::updateViewer()
{
    if (!myContext.IsNull()) {
        myContext->UpdateCurrentViewer();
    }
...
void TIGLCreatorContext::setTransparency(int tr)
{
...
void TIGLCreatorContext::setObjectsColor(const QColor& color)
{
