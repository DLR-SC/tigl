...
{
    static TIGLCreatorSettings settings;
    return settings;
}

TIGLCreatorSettings::TIGLCreatorSettings()
{
...
void TIGLCreatorSettings::setTesselationAccuracy(double accu)
{
    _tesselationAccuracy = accu;
}

void TIGLCreatorSettings::setTriangulationAccuracy(double accu)
{
    _triangulationAccuracy = accu;
}

void TIGLCreatorSettings::setBGColor(const QColor& col)
{
    _bgcolor = col;
}

void TIGLCreatorSettings::setShapeColor(const QColor& col)
{
    _shapecolor = col;
}

void TIGLCreatorSettings::setShapeSymmetryColor(const QColor& col)
{
    _shapesymmetrycolor = col;
}

void TIGLCreatorSettings::setDefaultMaterial(Graphic3d_NameOfMaterial material)
{
    _defaultMaterial = material;
}

Graphic3d_NameOfMaterial TIGLCreatorSettings::defaultMaterial() const
{
    return _defaultMaterial;
}

void TIGLCreatorSettings::setDefaultShapeColor(int r, int g, int b, int a)
{
    _shapecolor = QColor(r,g,b,a);
}

void TIGLCreatorSettings::setDefaultShapeSymmetryColor(int r, int g, int b, int a)
{
    _shapesymmetrycolor = QColor(r,g,b,a);
}

void TIGLCreatorSettings::setDefaultMaterial(const QString& material)
{
...
double TIGLCreatorSettings::triangulationAccuracy() const
{
    return _triangulationAccuracy;
}

const QColor& TIGLCreatorSettings::BGColor() const
{
    return _bgcolor;
}

const QColor& TIGLCreatorSettings::shapeColor() const
{
    return _shapecolor;
}

const QColor& TIGLCreatorSettings::shapeSymmetryColor() const
{
    return _shapesymmetrycolor;
}

void TIGLCreatorSettings::setDebugBooleanOperationsEnabled(bool enabled)
{
    _debugBOPs = enabled;
}

void TIGLCreatorSettings::setEnumerateFacesEnabled(bool enabled)
{
    _enumFaces = enabled;
}

void TIGLCreatorSettings::setNumberOfUIsolinesPerFace(int nlines)
{
    _nUIsosPerFace = nlines;
}

void TIGLCreatorSettings::setNumberOfVIsolinesPerFace(int nlines)
{
    _nVIsosPerFace = nlines;
}

void TIGLCreatorSettings::setDrawFaceBoundariesEnabled(bool enabled)
{
    _drawFaceBoundaries = enabled;
}

bool TIGLCreatorSettings::debugBooleanOperations() const
{
    return _debugBOPs;
}

bool TIGLCreatorSettings::enumerateFaces() const
{
    return _enumFaces;
}

int  TIGLCreatorSettings::numFaceUIsosForDisplay() const
{
    return _nUIsosPerFace;
}

int TIGLCreatorSettings::numFaceVIsosForDisplay() const
{
    return _nVIsosPerFace;
}

bool TIGLCreatorSettings::drawFaceBoundaries() const
{
...
void TIGLCreatorSettings::restoreDefaults()
{
...
QDir TIGLCreatorSettings::templateDir() const
{
    return _templateDir;
}

void TIGLCreatorSettings::setTemplateDir(QString path)
{
...
QString TIGLCreatorSettings::profilesDBPath() const
{
