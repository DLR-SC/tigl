...
* Changed: $Id: TIGLCreatorInputoutput.cpp 212 2012-10-15 15:33:53Z martinsiggel $
*
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::importModel( const FileFormat format, const QString& file )
{
...
bool TIGLCreatorInputOutput::exportModel( const QString& fileName,
                                         const FileFormat format,
...
bool TIGLCreatorInputOutput::exportModel( const FileFormat format, const QString& file, const Handle(TopTools_HSequenceOfShape)& shapes )
{
    bool status = false;
    try {
        switch ( format ) {
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::getShapes( const Handle(AIS_InteractiveContext)& ic )
{
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::importBREP( const QString& file )
{
    Handle(TopTools_HSequenceOfShape) aSequence;
    TopoDS_Shape aShape;
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::importIGES( const QString& file )
{
    Handle(TopTools_HSequenceOfShape) aSequence;
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::importSTL( const QString& file )
{
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::importMESH( const QString& file )
{
    Handle(TopTools_HSequenceOfShape) aSequence = nullptr;
...
Handle(TopTools_HSequenceOfShape) TIGLCreatorInputOutput::importSTEP( const QString& file )
{
...
bool TIGLCreatorInputOutput::exportBREP( const QString& file, const Handle(TopTools_HSequenceOfShape)& shapes )
{
...
bool TIGLCreatorInputOutput::exportIGES( const QString& file, const Handle(TopTools_HSequenceOfShape)& shapes )
{
    if ( shapes.IsNull() || shapes->IsEmpty() ) {
        return false;
    }
...
bool TIGLCreatorInputOutput::exportSTEP( const QString& file, const Handle(TopTools_HSequenceOfShape)& shapes )
{
    if ( shapes.IsNull() || shapes->IsEmpty() ) {
        return false;
    }
...
bool TIGLCreatorInputOutput::exportSTL( const QString& file, const Handle(TopTools_HSequenceOfShape)& shapes )
{
    if ( shapes.IsNull() || shapes->IsEmpty() ) {
        return false;
    }
...
bool TIGLCreatorInputOutput::checkFacetedBrep( const Handle(TopTools_HSequenceOfShape)& shapes )
{
    bool err = false;
    for ( int i = 1; i <= shapes->Length(); i++ ) {
        TopoDS_Shape shape = shapes->Value( i );
