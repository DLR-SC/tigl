...
TIGLCreatorSettingsDialog::TIGLCreatorSettingsDialog(TIGLCreatorSettings& settings, QWidget *parent)
...
double TIGLCreatorSettingsDialog::calcTesselationAccu(int value)
{
...
double TIGLCreatorSettingsDialog::calcTriangulationAccu(int value)
{
...
void TIGLCreatorSettingsDialog::onSettingsAccepted()
{
...
void TIGLCreatorSettingsDialog::onSliderTesselationChanged(int val)
{
    tessAccuEdit->setText(QString("%1").arg(val));
}

void TIGLCreatorSettingsDialog::onSliderTriangulationChanged(int val)
{
    trianAccuEdit->setText(QString("%1").arg(val));
}

void TIGLCreatorSettingsDialog::onColorChoserPushed()
{
...
void TIGLCreatorSettingsDialog::onShapeColorChoserPushed()
{
...
void TIGLCreatorSettingsDialog::onShapeSymmetryColorChoserPushed()
{
...
void TIGLCreatorSettingsDialog::onSettingsListChanged(int index)
{
    stackedWidget->setCurrentIndex(index);
}

void TIGLCreatorSettingsDialog::restoreDefaults()
{
    _settings.restoreDefaults();
    updateEntries();
}

void TIGLCreatorSettingsDialog::onBrowseTemplateDir()
{
...
void TIGLCreatorSettingsDialog::onBrowseProfilesDB()
{
    QString newFile =
