...
TIGLCreatorControlFile::TIGLCreatorControlFile() 
{
    showConsole  = UNDEFINED;
    showToolbars = UNDEFINED;
}

CF_ReturnCode TIGLCreatorControlFile::read(const char * filename)
{
    ...
    const char * prefix = "/TIGLCreator/console";
    int display = 1;
    ...
    const char * prefix2 = "/TIGLCreator/toolbars";
    display = 1;
