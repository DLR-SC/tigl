...
#ifndef TIGLCREATORSHAPEINTERSECTIONDIALOG_H
#define TIGLCREATORSHAPEINTERSECTIONDIALOG_H
...
namespace Ui
{
    class TIGLCreatorShapeIntersectionDialog;
}
...
class TIGLCreatorShapeIntersectionDialog : public QDialog
{
    Q_OBJECT

public:
    explicit TIGLCreatorShapeIntersectionDialog(tigl::CTiglUIDManager&, QWidget *parent = 0);
    ~TIGLCreatorShapeIntersectionDialog() override;
...
private:
    Ui::TIGLCreatorShapeIntersectionDialog *ui;
...
#endif // TIGLCREATORSHAPEINTERSECTIONDIALOG_H
