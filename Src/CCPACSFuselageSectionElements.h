...
* Changed: $Id: CCPACSFuselageSectionElements.h 4416 2011-02-08 21:03:40Z litz_ma $ 
*
...
namespace tigl {
	...
	public:
		// Constructor
		CCPACSFuselageSectionElements(void);

		// Virtual Destructor
		virtual ~CCPACSFuselageSectionElements(void);
