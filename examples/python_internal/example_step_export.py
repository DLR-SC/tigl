...
from tigl3.exports import CTiglExportStep

import os


def export_step(named_shapes, filename):
    """
    Exports the named shapes array to STEP
    """

    print("Exporting step file...")

    # write iges file
    step_writer = CTiglExportStep()
...
if __name__ == '__main__':
    ...
    export_step([fused_ac], "simpletest.stp")
